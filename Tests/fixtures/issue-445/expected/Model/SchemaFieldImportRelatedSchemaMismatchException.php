...
class SchemaFieldImportRelatedSchemaMismatchException extends \ArrayObject
{
     ...
     * @var string|null
     */
    protected $importingRelatedSchemaId;
    /**
     * 
     *
     * @var string|null
     */
    protected $existingRelatedSchemaId;
    /**
     * 
     *
     * @return string
     ...
     * 
     *
     * @param string|null $importingRelatedSchemaId
     *
     * @return self
     */
     ...
     * 
     *
     * @param string|null $existingRelatedSchemaId
     *
     * @return self
     */
