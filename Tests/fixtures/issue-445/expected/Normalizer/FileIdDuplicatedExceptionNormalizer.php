...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FileIdDuplicatedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\FileIdDuplicatedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\FileIdDuplicatedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\FileIdDuplicatedException();
            ...
            if (\array_key_exists('fileId', $data) && $data['fileId'] !== null) {
                $object->setFileId($data['fileId']);
                unset($data['fileId']);
            }
            elseif (\array_key_exists('fileId', $data) && $data['fileId'] === null) {
        ...
        {
            return [\PicturePark\API\Model\FileIdDuplicatedException::class => false];
        }
    }
} else {
    class FileIdDuplicatedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
