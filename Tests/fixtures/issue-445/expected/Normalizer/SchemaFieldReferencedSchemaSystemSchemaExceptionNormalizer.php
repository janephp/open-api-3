...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldReferencedSchemaSystemSchemaExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldReferencedSchemaSystemSchemaException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldReferencedSchemaSystemSchemaException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldReferencedSchemaSystemSchemaException();
            ...
            if (\array_key_exists('referencedSchemaId', $data) && $data['referencedSchemaId'] !== null) {
                $object->setReferencedSchemaId($data['referencedSchemaId']);
                unset($data['referencedSchemaId']);
            }
            elseif (\array_key_exists('referencedSchemaId', $data) && $data['referencedSchemaId'] === null) {
                $object->setReferencedSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('referencedSchemaId') && null !== $object->getReferencedSchemaId()) {
                $data['referencedSchemaId'] = $object->getReferencedSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldReferencedSchemaSystemSchemaException::class => false];
        }
    }
} else {
    class SchemaFieldReferencedSchemaSystemSchemaExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
