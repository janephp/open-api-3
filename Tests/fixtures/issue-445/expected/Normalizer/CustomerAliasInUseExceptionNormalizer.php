...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CustomerAliasInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\CustomerAliasInUseException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\CustomerAliasInUseException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\CustomerAliasInUseException();
            ...
            if (\array_key_exists('existingCustomerId', $data) && $data['existingCustomerId'] !== null) {
                $object->setExistingCustomerId($data['existingCustomerId']);
                unset($data['existingCustomerId']);
            }
            elseif (\array_key_exists('existingCustomerId', $data) && $data['existingCustomerId'] === null) {
                $object->setExistingCustomerId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('existingCustomerId') && null !== $object->getExistingCustomerId()) {
                $data['existingCustomerId'] = $object->getExistingCustomerId();
            }
        ...
        {
            return [\PicturePark\API\Model\CustomerAliasInUseException::class => false];
        }
    }
} else {
    class CustomerAliasInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
