...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SnapshotRetentionTimeTooShortExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SnapshotRetentionTimeTooShortException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SnapshotRetentionTimeTooShortException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SnapshotRetentionTimeTooShortException();
            ...
            if (\array_key_exists('snapshotRetentionTime', $data)) {
                $object->setSnapshotRetentionTime($data['snapshotRetentionTime']);
                unset($data['snapshotRetentionTime']);
            }
            if (\array_key_exists('minimumRetentionTime', $data)) {
                $object->setMinimumRetentionTime($data['minimumRetentionTime']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('snapshotRetentionTime') && null !== $object->getSnapshotRetentionTime()) {
                $data['snapshotRetentionTime'] = $object->getSnapshotRetentionTime();
            }
            if ($object->isInitialized('minimumRetentionTime') && null !== $object->getMinimumRetentionTime()) {
                $data['minimumRetentionTime'] = $object->getMinimumRetentionTime();
            }
        ...
        {
            return [\PicturePark\API\Model\SnapshotRetentionTimeTooShortException::class => false];
        }
    }
} else {
    class SnapshotRetentionTimeTooShortExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
