...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UserAlreadyInRequestedLockStateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\UserAlreadyInRequestedLockStateException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\UserAlreadyInRequestedLockStateException::class;
        }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('userIsLocked') && null !== $object->getUserIsLocked()) {
                $data['userIsLocked'] = $object->getUserIsLocked();
            }
        ...
        {
            return [\PicturePark\API\Model\UserAlreadyInRequestedLockStateException::class => false];
        }
    }
} else {
    class UserAlreadyInRequestedLockStateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
