...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ServiceProviderNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ServiceProviderNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ServiceProviderNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\ServiceProviderNotFoundException();
            ...
            if (\array_key_exists('missingServiceProviderId', $data) && $data['missingServiceProviderId'] !== null) {
                $object->setMissingServiceProviderId($data['missingServiceProviderId']);
                unset($data['missingServiceProviderId']);
            }
            elseif (\array_key_exists('missingServiceProviderId', $data) && $data['missingServiceProviderId'] === null) {
                $object->setMissingServiceProviderId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('missingServiceProviderId') && null !== $object->getMissingServiceProviderId()) {
                $data['missingServiceProviderId'] = $object->getMissingServiceProviderId();
            }
        ...
        {
            return [\PicturePark\API\Model\ServiceProviderNotFoundException::class => false];
        }
    }
} else {
    class ServiceProviderNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
