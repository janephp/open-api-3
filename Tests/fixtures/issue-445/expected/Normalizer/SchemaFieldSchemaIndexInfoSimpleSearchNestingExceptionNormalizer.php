...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldSchemaIndexInfoSimpleSearchNestingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldSchemaIndexInfoSimpleSearchNestingException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldSchemaIndexInfoSimpleSearchNestingException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldSchemaIndexInfoSimpleSearchNestingException();
            ...
            if (\array_key_exists('relatedFieldId', $data) && $data['relatedFieldId'] !== null) {
                $object->setRelatedFieldId($data['relatedFieldId']);
                unset($data['relatedFieldId']);
            }
            elseif (\array_key_exists('relatedFieldId', $data) && $data['relatedFieldId'] === null) {
                $object->setRelatedFieldId(null);
            }
            if (\array_key_exists('relatedOuterFieldId', $data) && $data['relatedOuterFieldId'] !== null) {
                $object->setRelatedOuterFieldId($data['relatedOuterFieldId']);
                unset($data['relatedOuterFieldId']);
            }
            elseif (\array_key_exists('relatedOuterFieldId', $data) && $data['relatedOuterFieldId'] === null) {
                $object->setRelatedOuterFieldId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('relatedFieldId') && null !== $object->getRelatedFieldId()) {
                $data['relatedFieldId'] = $object->getRelatedFieldId();
            }
            if ($object->isInitialized('relatedOuterFieldId') && null !== $object->getRelatedOuterFieldId()) {
                $data['relatedOuterFieldId'] = $object->getRelatedOuterFieldId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldSchemaIndexInfoSimpleSearchNestingException::class => false];
        }
    }
} else {
    class SchemaFieldSchemaIndexInfoSimpleSearchNestingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
