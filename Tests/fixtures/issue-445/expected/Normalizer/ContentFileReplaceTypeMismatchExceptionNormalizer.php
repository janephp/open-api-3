...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContentFileReplaceTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ContentFileReplaceTypeMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ContentFileReplaceTypeMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ContentFileReplaceTypeMismatchException();
            ...
            if (\array_key_exists('originalContentType', $data)) {
                $object->setOriginalContentType($data['originalContentType']);
                unset($data['originalContentType']);
            }
            if (\array_key_exists('newContentType', $data)) {
                $object->setNewContentType($data['newContentType']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('originalContentType') && null !== $object->getOriginalContentType()) {
                $data['originalContentType'] = $object->getOriginalContentType();
            }
            if ($object->isInitialized('newContentType') && null !== $object->getNewContentType()) {
                $data['newContentType'] = $object->getNewContentType();
            }
        ...
        {
            return [\PicturePark\API\Model\ContentFileReplaceTypeMismatchException::class => false];
        }
    }
} else {
    class ContentFileReplaceTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
