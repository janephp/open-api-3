...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TransferInfoNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\TransferInfoNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\TransferInfoNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\TransferInfoNotFoundException();
            ...
            if (\array_key_exists('transferInfoId', $data) && $data['transferInfoId'] !== null) {
                $object->setTransferInfoId($data['transferInfoId']);
                unset($data['transferInfoId']);
            }
            elseif (\array_key_exists('transferInfoId', $data) && $data['transferInfoId'] === null) {
                $object->setTransferInfoId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('transferInfoId') && null !== $object->getTransferInfoId()) {
                $data['transferInfoId'] = $object->getTransferInfoId();
            }
        ...
        {
            return [\PicturePark\API\Model\TransferInfoNotFoundException::class => false];
        }
    }
} else {
    class TransferInfoNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
