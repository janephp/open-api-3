...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return [\PicturePark\API\Model\BusinessProcess::class => false, \PicturePark\API\Model\BusinessProcessState::class => false, \PicturePark\API\Model\ErrorResponse::class => false, \PicturePark\API\Model\PictureparkValidationException::class => false, \PicturePark\API\Model\PictureparkBusinessException::class => false, \PicturePark\API\Model\PictureparkException::class => false, \PicturePark\API\Model\PictureparkConflictException::class => false, \PicturePark\API\Model\PictureparkTimeoutException::class => false, \PicturePark\API\Model\PictureparkForbiddenException::class => false, \PicturePark\API\Model\UserEmailAlreadyExistsException::class => false, \PicturePark\API\Model\UserRoleAssignedException::class => false, \PicturePark\API\Model\UnableToDeleteUserRoleException::class => false, \PicturePark\API\Model\UserNotFoundException::class => false, \PicturePark\API\Model\UserInactiveOrDeletedException::class => false, \PicturePark\API\Model\InactiveOrDeletedUserRefusedAccessException::class => false, \PicturePark\API\Model\TermsOfServiceNotNewestException::class => false, \PicturePark\API\Model\IllegalAuthorizationStateTransitionException::class => false, \PicturePark\API\Model\TermsOfServiceConsentRequiredException::class => false, \PicturePark\API\Model\UserRolesNotFoundException::class => false, \PicturePark\API\Model\PictureparkNotFoundException::class => false, \PicturePark\API\Model\UnauthorizedException::class => false, \PicturePark\API\Model\UserUnlockDisallowedException::class => false, \PicturePark\API\Model\UserAlreadyInRequestedLockStateException::class => false, \PicturePark\API\Model\LoginUsingIncorrectIdentityProviderException::class => false, \PicturePark\API\Model\IdentityProviderNotFoundException::class => false, \PicturePark\API\Model\UserDoesNotSupportLocalLoginException::class => false, \PicturePark\API\Model\UserAttributeNotSynchronizableException::class => false, \PicturePark\API\Model\UnableToMapMultipleClaimTypesIntoSameAttributeException::class => false, \PicturePark\API\Model\UnableToChangeMappedUserRolesForFederatedUserException::class => false, \PicturePark\API\Model\UnableToDeleteDefaultUserRoleException::class => false, \PicturePark\API\Model\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException::class => false, \PicturePark\API\Model\UserPropertyChangeNotSupportedException::class => false, \PicturePark\API\Model\RenderingException::class => false, \PicturePark\API\Model\FormatNotApplicableForRenderingException::class => false, \PicturePark\API\Model\ServiceProviderDeleteException::class => false, \PicturePark\API\Model\ServiceProviderCreateException::class => false, \PicturePark\API\Model\ServiceProviderNotFoundException::class => false, \PicturePark\API\Model\DocumentVersionNotFoundException::class => false, \PicturePark\API\Model\DefaultChannelDeleteException::class => false, \PicturePark\API\Model\ChannelsNotFoundException::class => false, \PicturePark\API\Model\SuperAdminRolesNotAssignableToChannelException::class => false, \PicturePark\API\Model\ElasticVersionUpdateException::class => false, \PicturePark\API\Model\InvalidVersionException::class => false, \PicturePark\API\Model\EnvironmentNotDeactivatedException::class => false, \PicturePark\API\Model\EnvironmentNotFoundException::class => false, \PicturePark\API\Model\EnvironmentDeactivationException::class => false, \PicturePark\API\Model\CustomerClonesNotAcceptedException::class => false, \PicturePark\API\Model\ShareNotFoundException::class => false, \PicturePark\API\Model\ShareByTokenNotFoundException::class => false, \PicturePark\API\Model\TokenGenerationException::class => false, \PicturePark\API\Model\ShareExpiredException::class => false, \PicturePark\API\Model\ShareSizeLimitExceededException::class => false, \PicturePark\API\Model\OutputIdNotFoundException::class => false, \PicturePark\API\Model\OutputNotFoundException::class => false, \PicturePark\API\Model\UnableToCreateOrModifyStaticOutputFormatException::class => false, \PicturePark\API\Model\NotSupportedFileMappingException::class => false, \PicturePark\API\Model\NotSupportedFileMappingForDynamicFormatException::class => false, \PicturePark\API\Model\NotSupportedFileExtensionException::class => false, \PicturePark\API\Model\DuplicateOutputFormatIdException::class => false, \PicturePark\API\Model\OutputFormatResizingNotSupportedException::class => false, \PicturePark\API\Model\OutputBackupNotRequestedException::class => false, \PicturePark\API\Model\DownloadLinkExpiredException::class => false, \PicturePark\API\Model\RenderingNotAwaitedException::class => false, \PicturePark\API\Model\LeaseNotAcquiredException::class => false, \PicturePark\API\Model\OperationInProgressException::class => false, \PicturePark\API\Model\RetryException::class => false, \PicturePark\API\Model\OwnerTokenNotFoundException::class => false, \PicturePark\API\Model\InvalidStateException::class => false, \PicturePark\API\Model\PictureparkArgumentNullException::class => false, \PicturePark\API\Model\ObjectTypeMismatchException::class => false, \PicturePark\API\Model\InvalidStateTransitionException::class => false, \PicturePark\API\Model\FailedToLockException::class => false, \PicturePark\API\Model\PictureparkOperationCanceledException::class => false, \PicturePark\API\Model\PictureparkApplicationException::class => false, \PicturePark\API\Model\MissingCustomerDefaultLanguageException::class => false, \PicturePark\API\Model\PartialOperationNotSupportedException::class => false, \PicturePark\API\Model\ContractMismatchException::class => false, \PicturePark\API\Model\InvalidArgumentException::class => false, \PicturePark\API\Model\ArgumentRangeException::class => false, \PicturePark\API\Model\UnknownException::class => false, \PicturePark\API\Model\OwnerTokenInUseException::class => false, \PicturePark\API\Model\InvalidValueFormatException::class => false, \PicturePark\API\Model\ItemIdDuplicatedException::class => false, \PicturePark\API\Model\RequestSizeLimitExceededException::class => false, \PicturePark\API\Model\CustomerViolationException::class => false, \PicturePark\API\Model\CustomerAliasNotFoundException::class => false, \PicturePark\API\Model\CustomerAliasInUseException::class => false, \PicturePark\API\Model\CustomerNotDeactivatedException::class => false, \PicturePark\API\Model\CustomerDeactivationException::class => false, \PicturePark\API\Model\CustomerHostNotFoundException::class => false, \PicturePark\API\Model\CustomerNotFoundException::class => false, \PicturePark\API\Model\CustomerNotActiveException::class => false, \PicturePark\API\Model\CustomerBoostValuesInvalidException::class => false, \PicturePark\API\Model\SnapshotRetentionTimeTooShortException::class => false, \PicturePark\API\Model\ReshardIndexNotAllowedException::class => false, \PicturePark\API\Model\ReshardNumberOfShardsInvalidException::class => false, \PicturePark\API\Model\ReshardNumberOfRoutingShardsInvalidException::class => false, \PicturePark\API\Model\ReshardNumberOfShardsInvalidForExistingRoutingShardsException::class => false, \PicturePark\API\Model\ConfigurationIndexNotFoundException::class => false, \PicturePark\API\Model\DuplicateSearchIndexDocException::class => false, \PicturePark\API\Model\SearchIndexDocNotFoundException::class => false, \PicturePark\API\Model\IndexDocumentNotFoundException::class => false, \PicturePark\API\Model\DuplicateAliasException::class => false, \PicturePark\API\Model\SearchIndexNotFoundException::class => false, \PicturePark\API\Model\DefaultSearchIndexDeleteException::class => false, \PicturePark\API\Model\SearchIndexInUseException::class => false, \PicturePark\API\Model\IndexException::class => false, \PicturePark\API\Model\IndexMappingException::class => false, \PicturePark\API\Model\DuplicatedSearchBehaviorException::class => false, \PicturePark\API\Model\SearchStringLeadingWildcardException::class => false, \PicturePark\API\Model\DuplicateAggregatorException::class => false, \PicturePark\API\Model\InvalidDateTimeFormatException::class => false, \PicturePark\API\Model\InvalidSortFieldException::class => false, \PicturePark\API\Model\DocumentVersionConflictException::class => false, \PicturePark\API\Model\RedisDatabaseExceededException::class => false, \PicturePark\API\Model\DuplicateDocumentException::class => false, \PicturePark\API\Model\ObjectStoreResponseException::class => false, \PicturePark\API\Model\ObjectStoreException::class => false, \PicturePark\API\Model\QueryException::class => false, \PicturePark\API\Model\PermissionOwnershipTransferException::class => false, \PicturePark\API\Model\PermissionSetNotFoundException::class => false, \PicturePark\API\Model\PermissionSetAggregateException::class => false, \PicturePark\API\Model\DuplicateRightException::class => false, \PicturePark\API\Model\PermissionValidationException::class => false, \PicturePark\API\Model\PermissionSetInUseException::class => false, \PicturePark\API\Model\ContentPermissionException::class => false, \PicturePark\API\Model\ListItemPermissionException::class => false, \PicturePark\API\Model\SchemaPermissionException::class => false, \PicturePark\API\Model\PermissionSetInvalidRightCombinationException::class => false, \PicturePark\API\Model\PermissionSetValidationException::class => false, \PicturePark\API\Model\AmbiguousUserRoleRightsException::class => false, \PicturePark\API\Model\UnsupportedListItemChangeCommandException::class => false, \PicturePark\API\Model\ListItemLayerException::class => false, \PicturePark\API\Model\ListItemNotFoundException::class => false, \PicturePark\API\Model\ListItemCyclicDependencyException::class => false, \PicturePark\API\Model\DeleteListItemsWithReferencesException::class => false, \PicturePark\API\Model\ListItemUpdateManyException::class => false, \PicturePark\API\Model\ListItemSchemaMismatchException::class => false, \PicturePark\API\Model\TransferInfoNotFoundException::class => false, \PicturePark\API\Model\FileTransferNotFoundException::class => false, \PicturePark\API\Model\InvalidTransferTypeException::class => false, \PicturePark\API\Model\TransferNotFoundException::class => false, \PicturePark\API\Model\WrongChunkSizeException::class => false, \PicturePark\API\Model\ChunkSizeOutOfRangeException::class => false, \PicturePark\API\Model\MaximumTransferSizeException::class => false, \PicturePark\API\Model\FileIdDuplicatedException::class => false, \PicturePark\API\Model\MissingDependenciesException::class => false, \PicturePark\API\Model\RelationSelfReferencingException::class => false, \PicturePark\API\Model\InvalidChangeCommandFieldTypeInvalidException::class => false, \PicturePark\API\Model\InvalidChangeCommandFieldNotFoundException::class => false, \PicturePark\API\Model\InvalidChangeCommandSchemaChangeInvalidException::class => false, \PicturePark\API\Model\InvalidMetadataException::class => false, \PicturePark\API\Model\MetadataError::class => false, \PicturePark\API\Model\RelationNotFoundException::class => false, \PicturePark\API\Model\RelationTypeNotFoundException::class => false, \PicturePark\API\Model\RelationTypeTargetDocTypeMismatchException::class => false, \PicturePark\API\Model\AggregationNameInvalidException::class => false, \PicturePark\API\Model\AggregationSizeInvalidException::class => false, \PicturePark\API\Model\AggregationFilterNotSupportedException::class => false, \PicturePark\API\Model\RelationTypeMissingException::class => false, \PicturePark\API\Model\ReferencesUpdateException::class => false, \PicturePark\API\Model\ReferenceUpdateException::class => false, \PicturePark\API\Model\DuplicatedItemAssignedException::class => false, \PicturePark\API\Model\InvalidDataTypeException::class => false, \PicturePark\API\Model\LayerAssignmentInvalidException::class => false, \PicturePark\API\Model\OutdatedMetadataUpdateInProgressException::class => false, \PicturePark\API\Model\SchemaFieldOverwriteTypeMismatchException::class => false, \PicturePark\API\Model\SchemaFieldOverwriteIdException::class => false, \PicturePark\API\Model\SchemaFieldIdDuplicatedException::class => false, \PicturePark\API\Model\SchemaFieldIdPreviouslyUsedException::class => false, \PicturePark\API\Model\SchemaFieldIdAlreadyExistsInSchemaHierarchyException::class => false, \PicturePark\API\Model\SchemaFieldSchemaIndexInfoSimpleSearchNestingException::class => false, \PicturePark\API\Model\SchemaFieldSchemaIndexInfoNestingException::class => false, \PicturePark\API\Model\SchemaFieldIdUppercaseException::class => false, \PicturePark\API\Model\SchemaIdLowercaseException::class => false, \PicturePark\API\Model\SchemaInfoNotFoundException::class => false, \PicturePark\API\Model\IndexedFieldThresholdExceededException::class => false, \PicturePark\API\Model\SortableFieldThresholdExceededException::class => false, \PicturePark\API\Model\DuplicateSchemaInfoException::class => false, \PicturePark\API\Model\SchemaFieldNumberRangeException::class => false, \PicturePark\API\Model\SchemaInUseContentSchemaException::class => false, \PicturePark\API\Model\LayerAssignmentInUseWithContentsException::class => false, \PicturePark\API\Model\SchemaInUseListItemException::class => false, \PicturePark\API\Model\SchemaInUseContentException::class => false, \PicturePark\API\Model\SchemaInUseFieldException::class => false, \PicturePark\API\Model\DuplicateMetadataDisplayPatternException::class => false, \PicturePark\API\Model\DuplicateSchemaException::class => false, \PicturePark\API\Model\SchemaImportEmptyException::class => false, \PicturePark\API\Model\SchemaImportVersionMismatchException::class => false, \PicturePark\API\Model\SchemaInheritanceFieldIndexDeviationException::class => false, \PicturePark\API\Model\SchemaInheritanceTypeDeviationException::class => false, \PicturePark\API\Model\SchemaValidationException::class => false, \PicturePark\API\Model\SchemaSortFieldException::class => false, \PicturePark\API\Model\SchemaFieldIdException::class => false, \PicturePark\API\Model\SchemaFieldTypeChangeException::class => false, \PicturePark\API\Model\SchemaFieldIndexException::class => false, \PicturePark\API\Model\SchemaFieldNotSortableException::class => false, \PicturePark\API\Model\SchemaFieldNotSearchableException::class => false, \PicturePark\API\Model\SchemaFieldInvalidBoostException::class => false, \PicturePark\API\Model\SchemaFieldSortableInUseException::class => false, \PicturePark\API\Model\SchemaNoContentException::class => false, \PicturePark\API\Model\SchemaParentChangeException::class => false, \PicturePark\API\Model\SchemaMissingTypeException::class => false, \PicturePark\API\Model\SchemaPermissionConfigurationException::class => false, \PicturePark\API\Model\SchemaNoLayerException::class => false, \PicturePark\API\Model\SchemaIdException::class => false, \PicturePark\API\Model\SchemaInUseException::class => false, \PicturePark\API\Model\SchemaNotFoundException::class => false, \PicturePark\API\Model\SchemaCountLimitReachedException::class => false, \PicturePark\API\Model\SystemSchemaInvalidModificationException::class => false, \PicturePark\API\Model\SchemaFieldRelationSchemaSystemSchemaException::class => false, \PicturePark\API\Model\SchemaFieldRelationSchemaTypeUnsupportedException::class => false, \PicturePark\API\Model\SchemaMultipleTypesException::class => false, \PicturePark\API\Model\MissingDisplayPatternForCustomerDefaultLanguageException::class => false, \PicturePark\API\Model\SchemaViewForAllException::class => false, \PicturePark\API\Model\SystemLayerReferenceInvalidModificationException::class => false, \PicturePark\API\Model\SchemaFieldAnalyzerInvalidException::class => false, \PicturePark\API\Model\SchemaFieldRelationMultipleTypesException::class => false, \PicturePark\API\Model\SchemaFieldNotRequirableException::class => false, \PicturePark\API\Model\DisplayPatternTypeNotSupportedException::class => false, \PicturePark\API\Model\SchemaFieldActivityInUseException::class => false, \PicturePark\API\Model\SchemaFieldReferencedSchemaChangeNotAllowedException::class => false, \PicturePark\API\Model\SchemaFieldReferencedSchemaSystemSchemaException::class => false, \PicturePark\API\Model\SchemaFieldRelationRelationTypeIdModificationNotAllowedException::class => false, \PicturePark\API\Model\SchemaFieldRelationTargetDocTypeModificationNotAllowedException::class => false, \PicturePark\API\Model\DeleteContentsWithReferencesException::class => false, \PicturePark\API\Model\ContentMetadataUpdateManyException::class => false, \PicturePark\API\Model\ContentNotFoundException::class => false, \PicturePark\API\Model\ContentLayerInvalidException::class => false, \PicturePark\API\Model\ContentFileReplaceTypeMismatchException::class => false, \PicturePark\API\Model\ContentBackupFailedException::class => false, \PicturePark\API\Model\ContentLayerSameRootException::class => false, \PicturePark\API\Model\LayerIdsByRootSchema::class => false, \PicturePark\API\Model\BusinessProcessEngineRequestException::class => false, \PicturePark\API\Model\BusinessProcessNotFoundException::class => false, \PicturePark\API\Model\BusinessProcessDefinitionNotFoundException::class => false, \PicturePark\API\Model\BusinessProcessDefinitionCreateException::class => false, \PicturePark\API\Model\BusinessProcessNotExternalException::class => false, \PicturePark\API\Model\BusinessProcessCancellationNotSupportedException::class => false, \PicturePark\API\Model\BusinessProcessContinuationException::class => false, \PicturePark\API\Model\SchemaFieldImportMismatchException::class => false, \PicturePark\API\Model\SchemaFieldImportRelatedSchemaMismatchException::class => false, \PicturePark\API\Model\SchemaFieldImportTypeMismatchException::class => false, \PicturePark\API\Model\SchemaFieldNotSupportedException::class => false, \PicturePark\API\Model\SchemaFieldDisplayPatternTypeNotSupportedException::class => false, \PicturePark\API\Model\SnapshotTimeoutException::class => false, \PicturePark\API\Model\SnapshotFailedException::class => false, \PicturePark\API\Model\SnapshotSkippedException::class => false, \PicturePark\API\Model\AddMetadataLanguageTimeoutException::class => false, \PicturePark\API\Model\EnvironmentProcessAlreadyRunningException::class => false, \PicturePark\API\Model\EnvironmentProcessNotFoundException::class => false, \PicturePark\API\Model\EnvironmentProcessWaitTimeoutException::class => false, \PicturePark\API\Model\CustomerBoostValuesUpdateTimeoutException::class => false, \PicturePark\API\Model\NoTermsOfServiceDefinedException::class => false, \PicturePark\API\Model\AtLeastOneActiveTermsOfServiceMustExistException::class => false, \PicturePark\API\Model\ForbiddenHtmlElementsUsedException::class => false, \PicturePark\API\Model\BusinessProcessStateNotHitException::class => false, \PicturePark\API\Model\BusinessProcessLifeCycleNotHitException::class => false, \PicturePark\API\Model\OnlyAccessibleToRecipientException::class => false, \PicturePark\API\Model\EnvironmentNotAvailableException::class => false, \PicturePark\API\Model\CustomerNotAvailableException::class => false, \PicturePark\API\Model\CustomerAliasHeaderMissingException::class => false, \PicturePark\API\Model\BusinessRuleActionInvalidDocumentTypeException::class => false, \PicturePark\API\Model\BusinessRuleActionInvalidExecutionScopeException::class => false, \PicturePark\API\Model\BusinessRuleActionsMissingException::class => false, \PicturePark\API\Model\BusinessRuleConditionMissingException::class => false, \PicturePark\API\Model\BusinessRuleConditionsMissingException::class => false, \PicturePark\API\Model\BusinessRuleConfigurationValidationException::class => false, \PicturePark\API\Model\BusinessRuleSchemaIdInvalidException::class => false, \PicturePark\API\Model\BusinessRulePermissionSetIdInvalidException::class => false, \PicturePark\API\Model\BusinessRuleRuleIdDuplicationException::class => false, \PicturePark\API\Model\BusinessRuleRuleIdMissingException::class => false, \PicturePark\API\Model\BusinessRuleTriggerPointMissingException::class => false, \PicturePark\API\Model\BusinessRuleValidationException::class => false, \PicturePark\API\Model\BusinessRuleConditionInvalidTriggerPointDocumentTypeException::class => false, \PicturePark\API\Model\BusinessRuleRegularExpressionInvalidException::class => false, \PicturePark\API\Model\BusinessRuleConditionInvalidTriggerPointActionException::class => false, \PicturePark\API\Model\BusinessRuleRefIdsMissingException::class => false, \PicturePark\API\Model\BusinessRulePathInvalidException::class => false, \PicturePark\API\Model\BusinessRuleFieldIdInvalidException::class => false, \PicturePark\API\Model\BusinessRuleContentPermissionSetIdsMissingException::class => false, \PicturePark\API\Model\BusinessRuleFieldPathInvalidException::class => false, \PicturePark\API\Model\BusinessRulePolygonInvalidException::class => false, \PicturePark\API\Model\BusinessRuleArrayIndexInvalidException::class => false, \PicturePark\API\Model\BusinessRuleDictionaryKeyInvalidException::class => false, \PicturePark\API\Model\BusinessRuleProjectionTransformationsMissingException::class => false, \PicturePark\API\Model\BusinessRuleInvalidVariableNameException::class => false, \PicturePark\API\Model\BusinessRuleTransformationGroupTransformationsMissingException::class => false, \PicturePark\API\Model\BusinessRuleTransformationGroupInputsMissingException::class => false, \PicturePark\API\Model\BusinessRuleNamedCacheNameInvalidException::class => false, \PicturePark\API\Model\BusinessRuleNGramTransformationSizeInvalidException::class => false, \PicturePark\API\Model\BusinessRuleNGramTransformationMinWordLengthInvalidException::class => false, \PicturePark\API\Model\BusinessRuleNGramTransformationMaxWordLengthInvalidException::class => false, \PicturePark\API\Model\NamedCacheConfigurationException::class => false, \PicturePark\API\Model\NamedCacheNameMissingException::class => false, \PicturePark\API\Model\NamedCacheNameDuplicationException::class => false, \PicturePark\API\Model\ListItemNamedCacheSchemaIdInvalidException::class => false, \PicturePark\API\Model\ListItemNamedCacheKeyFieldsInvalidException::class => false, \PicturePark\API\Model\SchemaTagboxFilterLookupNamedCacheSchemaIdInvalidException::class => false, \PicturePark\API\Model\NoTagsFoundException::class => false, \PicturePark\API\Model\OutputNotAvailableException::class => false, \PicturePark\API\Model\ModelNotFoundException::class => false, \PicturePark\API\Model\DisplayValueRerenderingInProgressException::class => false, \PicturePark\API\Model\OutputFormatNotFoundException::class => false, \PicturePark\API\Model\OutputFormatSourceNotDefinedException::class => false, \PicturePark\API\Model\OutputFormatRetentionTimeOutOfRangeException::class => false, \PicturePark\API\Model\NotSupportedFileExtensionForFormatException::class => false, \PicturePark\API\Model\OutputFormatXmpWritebackNotSupportedException::class => false, \PicturePark\API\Model\CollectionSizeLimitExceededException::class => false, \PicturePark\API\Model\XmpMappingFieldNotSupported::class => false, \PicturePark\API\Model\XmpMappingFieldNotFoundException::class => false, \PicturePark\API\Model\XmpMappingSchemaNotAvailableForFileContentSchemaException::class => false, \PicturePark\API\Model\XmpMappingFieldToLayerWithRequiredFieldsNotAllowedException::class => false, \PicturePark\API\Model\XmpMappingFieldInUseException::class => false, \PicturePark\API\Model\XmpMappingConfigurationInvalidException::class => false, \PicturePark\API\Model\ActivityMappingInvalidException::class => false, \PicturePark\API\Model\ProblemDetails::class => false, \PicturePark\API\Model\BusinessProcessCreateRequest::class => false, \PicturePark\API\Model\BusinessProcessNotificationUpdate::class => false, \PicturePark\API\Model\BusinessProcessStateChangeRequest::class => false, \PicturePark\API\Model\BusinessProcessNotificationUpdateRequest::class => false, \PicturePark\API\Model\BusinessProcessWaitForStateResult::class => false, \PicturePark\API\Model\BusinessProcessWaitForLifeCycleResult::class => false, \PicturePark\API\Model\BusinessProcessDetails::class => false, \PicturePark\API\Model\BusinessProcessDetailsDataBase::class => false, \PicturePark\API\Model\BusinessProcessDetailsDataBatchResponse::class => false, \PicturePark\API\Model\BatchResponse::class => false, \PicturePark\API\Model\BatchResponseRow::class => false, \PicturePark\API\Model\BusinessProcessDetailsDataSchemaImport::class => false, \PicturePark\API\Model\SchemaImportResult::class => false, \PicturePark\API\Model\ListItemImportResult::class => false, \PicturePark\API\Model\BusinessProcessDetailsDataCdnPurge::class => false, \PicturePark\API\Model\CdnPurgeJobBase::class => false, \PicturePark\API\Model\CdnPurgeJobByTag::class => false, \PicturePark\API\Model\CdnPurgeJobByUri::class => false, \PicturePark\API\Model\BusinessProcessDetailsDataContentImport::class => false, \PicturePark\API\Model\ContentImportResult::class => false, \PicturePark\API\Model\BusinessProcessSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfBusinessProcess::class => false, \PicturePark\API\Model\QueryDebugInformation::class => false, \PicturePark\API\Model\BaseResultOfBusinessProcess::class => false, \PicturePark\API\Model\BusinessProcessSearchRequest::class => false, \PicturePark\API\Model\FilterBase::class => false, \PicturePark\API\Model\AndFilter::class => false, \PicturePark\API\Model\OrFilter::class => false, \PicturePark\API\Model\NotFilter::class => false, \PicturePark\API\Model\DateRangeFilter::class => false, \PicturePark\API\Model\DateRange::class => false, \PicturePark\API\Model\ExistsFilter::class => false, \PicturePark\API\Model\GeoBoundingBoxFilter::class => false, \PicturePark\API\Model\GeoLocation::class => false, \PicturePark\API\Model\GeoDistanceFilter::class => false, \PicturePark\API\Model\NestedFilter::class => false, \PicturePark\API\Model\NumericRangeFilter::class => false, \PicturePark\API\Model\NumericRange::class => false, \PicturePark\API\Model\PrefixFilter::class => false, \PicturePark\API\Model\TermFilter::class => false, \PicturePark\API\Model\TermsFilter::class => false, \PicturePark\API\Model\AggregationFilter::class => false, \PicturePark\API\Model\ChildFilter::class => false, \PicturePark\API\Model\ParentFilter::class => false, \PicturePark\API\Model\BusinessRuleConfiguration::class => false, \PicturePark\API\Model\BusinessRule::class => false, \PicturePark\API\Model\BusinessRuleTriggerPoint::class => false, \PicturePark\API\Model\BusinessRuleConfigurable::class => false, \PicturePark\API\Model\BusinessRuleCondition::class => false, \PicturePark\API\Model\AndCondition::class => false, \PicturePark\API\Model\BooleanCondition::class => false, \PicturePark\API\Model\OrCondition::class => false, \PicturePark\API\Model\LayerAssignedCondition::class => false, \PicturePark\API\Model\LayerUnassignedCondition::class => false, \PicturePark\API\Model\ContentPermissionSetAssignedCondition::class => false, \PicturePark\API\Model\ContentPermissionSetUnassignedCondition::class => false, \PicturePark\API\Model\FieldValueChangedCondition::class => false, \PicturePark\API\Model\MatchRegexCondition::class => false, \PicturePark\API\Model\TagboxItemAssignedCondition::class => false, \PicturePark\API\Model\TagboxItemUnassignedCondition::class => false, \PicturePark\API\Model\ContentSchemaCondition::class => false, \PicturePark\API\Model\NumberCompareCondition::class => false, \PicturePark\API\Model\ContentRelationItemAssignedCondition::class => false, \PicturePark\API\Model\ContentRelationItemUnassignedCondition::class => false, \PicturePark\API\Model\GeoPointWithinPolygonCondition::class => false, \PicturePark\API\Model\LatLon::class => false, \PicturePark\API\Model\ContentPermissionSetsChangedCondition::class => false, \PicturePark\API\Model\ContentRelationItemsChangedCondition::class => false, \PicturePark\API\Model\LayersChangedCondition::class => false, \PicturePark\API\Model\TagboxItemsChangedCondition::class => false, \PicturePark\API\Model\FieldEmptyCondition::class => false, \PicturePark\API\Model\NotCondition::class => false, \PicturePark\API\Model\BusinessRuleTransformationGroup::class => false, \PicturePark\API\Model\BusinessRuleTransformation::class => false, \PicturePark\API\Model\TakeDictionaryValueTransformation::class => false, \PicturePark\API\Model\TakeArrayValueTransformation::class => false, \PicturePark\API\Model\JoinByTransformation::class => false, \PicturePark\API\Model\LookupCacheTransformation::class => false, \PicturePark\API\Model\NGramTransformation::class => false, \PicturePark\API\Model\ProjectionTransformation::class => false, \PicturePark\API\Model\SplitTransformation::class => false, \PicturePark\API\Model\BusinessRuleAction::class => false, \PicturePark\API\Model\AssignLayerAction::class => false, \PicturePark\API\Model\UnassignLayerAction::class => false, \PicturePark\API\Model\AssignValueAction::class => false, \PicturePark\API\Model\AssignTagboxItemsAction::class => false, \PicturePark\API\Model\UnassignTagboxItemsAction::class => false, \PicturePark\API\Model\AssignContentPermissionSetsAction::class => false, \PicturePark\API\Model\UnassignContentPermissionSetsAction::class => false, \PicturePark\API\Model\ProduceMessageAction::class => false, \PicturePark\API\Model\AssignTagboxItemsInLayerAction::class => false, \PicturePark\API\Model\EnqueueTaggingAction::class => false, \PicturePark\API\Model\TaggingOptionsBase::class => false, \PicturePark\API\Model\ClarifaiTaggingOptions::class => false, \PicturePark\API\Model\SimulatedTaggingOptions::class => false, \PicturePark\API\Model\BusinessRuleScript::class => false, \PicturePark\API\Model\NamedCacheConfigurationBase::class => false, \PicturePark\API\Model\ListItemNamedCacheConfiguration::class => false, \PicturePark\API\Model\SchemaTagboxFilterLookupNamedCacheConfiguration::class => false, \PicturePark\API\Model\InverseListItemNamedCacheConfiguration::class => false, \PicturePark\API\Model\BusinessRuleConfigurationUpdateRequest::class => false, \PicturePark\API\Model\BusinessRuleTraceLogSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfBusinessRuleTraceLog::class => false, \PicturePark\API\Model\AggregationResult::class => false, \PicturePark\API\Model\AggregationResultItem::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfBusinessRuleTraceLog::class => false, \PicturePark\API\Model\BaseResultOfBusinessRuleTraceLog::class => false, \PicturePark\API\Model\BusinessRuleTraceLog::class => false, \PicturePark\API\Model\BusinessRuleTracedRule::class => false, \PicturePark\API\Model\BusinessRuleTracedEvaluation::class => false, \PicturePark\API\Model\BusinessRuleTracedEvaluationCondition::class => false, \PicturePark\API\Model\BusinessRuleTracedTransformationGroup::class => false, \PicturePark\API\Model\BusinessRuleTracedTransformation::class => false, \PicturePark\API\Model\BusinessRuleTracedAction::class => false, \PicturePark\API\Model\UserAudit::class => false, \PicturePark\API\Model\BusinessRuleTraceLogSearchRequest::class => false, \PicturePark\API\Model\AggregatorBase::class => false, \PicturePark\API\Model\DateRangeAggregator::class => false, \PicturePark\API\Model\DateRangeForAggregator::class => false, \PicturePark\API\Model\GeoDistanceAggregator::class => false, \PicturePark\API\Model\GeoDistance::class => false, \PicturePark\API\Model\NestedAggregator::class => false, \PicturePark\API\Model\NumericRangeAggregator::class => false, \PicturePark\API\Model\NumericRangeForAggregator::class => false, \PicturePark\API\Model\TermsAggregator::class => false, \PicturePark\API\Model\TermsRelationAggregator::class => false, \PicturePark\API\Model\TermsEnumAggregator::class => false, \PicturePark\API\Model\SortInfo::class => false, \PicturePark\API\Model\Channel::class => false, \PicturePark\API\Model\SortField::class => false, \PicturePark\API\Model\ChannelCreateRequest::class => false, \PicturePark\API\Model\ChannelUpdateRequest::class => false, \PicturePark\API\Model\ContentPermissionSetDetail::class => false, \PicturePark\API\Model\PermissionSetDetailOfContentRight::class => false, \PicturePark\API\Model\PermissionUserRoleRightsOfContentRight::class => false, \PicturePark\API\Model\PermissionUserRoleRightsOfPermissionSetRight::class => false, \PicturePark\API\Model\UserAuditDetail::class => false, \PicturePark\API\Model\User::class => false, \PicturePark\API\Model\ContentPermissionSetCreateRequest::class => false, \PicturePark\API\Model\PermissionSetCreateRequestOfContentRight::class => false, \PicturePark\API\Model\UserRoleRightsOfContentRight::class => false, \PicturePark\API\Model\UserRoleRightsOfPermissionSetRight::class => false, \PicturePark\API\Model\ContentPermissionSetUpdateRequest::class => false, \PicturePark\API\Model\PermissionSetUpdateRequestOfContentRight::class => false, \PicturePark\API\Model\PermissionSetOwnershipTransferRequest::class => false, \PicturePark\API\Model\BulkResponse::class => false, \PicturePark\API\Model\BulkResponseRow::class => false, \PicturePark\API\Model\ContentPermissionSetCreateManyRequest::class => false, \PicturePark\API\Model\ContentPermissionSetUpdateManyRequest::class => false, \PicturePark\API\Model\ContentPermissionSetUpdateRequestItem::class => false, \PicturePark\API\Model\PermissionSetUpdateRequestItemOfContentRight::class => false, \PicturePark\API\Model\PermissionSetDeleteManyRequest::class => false, \PicturePark\API\Model\PermissionSetOwnershipTransferManyRequest::class => false, \PicturePark\API\Model\PermissionSetOwnershipTransferItem::class => false, \PicturePark\API\Model\PermissionSetUserPermissionRights::class => false, \PicturePark\API\Model\PermissionSetSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfPermissionSet::class => false, \PicturePark\API\Model\BaseResultOfPermissionSet::class => false, \PicturePark\API\Model\PermissionSet::class => false, \PicturePark\API\Model\PermissionSetSearchRequest::class => false, \PicturePark\API\Model\ContentDetail::class => false, \PicturePark\API\Model\Output::class => false, \PicturePark\API\Model\OutputDataBase::class => false, \PicturePark\API\Model\OutputDataImage::class => false, \PicturePark\API\Model\OutputDataAudio::class => false, \PicturePark\API\Model\OutputDataVideo::class => false, \PicturePark\API\Model\Sprite::class => false, \PicturePark\API\Model\OutputDataDocument::class => false, \PicturePark\API\Model\OutputDataVector::class => false, \PicturePark\API\Model\OutputDataDefault::class => false, \PicturePark\API\Model\OutputDetail::class => false, \PicturePark\API\Model\Activity::class => false, \PicturePark\API\Model\ContentCreateRequest::class => false, \PicturePark\API\Model\ContentMetadataUpdateRequest::class => false, \PicturePark\API\Model\ContentPermissionsUpdateRequest::class => false, \PicturePark\API\Model\ContentOwnershipTransferRequest::class => false, \PicturePark\API\Model\ContentFileUpdateRequest::class => false, \PicturePark\API\Model\ContentReferencesResult::class => false, \PicturePark\API\Model\MetadataReferenceResult::class => false, \PicturePark\API\Model\BaseResultOfMetadataReference::class => false, \PicturePark\API\Model\MetadataReference::class => false, \PicturePark\API\Model\ContentShareReferenceResult::class => false, \PicturePark\API\Model\BaseResultOfContentShareReference::class => false, \PicturePark\API\Model\ContentShareReference::class => false, \PicturePark\API\Model\ContentReferencesRequest::class => false, \PicturePark\API\Model\MetadataReferencesPagingRequest::class => false, \PicturePark\API\Model\PagingRequest::class => false, \PicturePark\API\Model\OutputResolveResult::class => false, \PicturePark\API\Model\ContentDownloadLinkCreateRequest::class => false, \PicturePark\API\Model\ContentDownloadRequestItem::class => false, \PicturePark\API\Model\DownloadLink::class => false, \PicturePark\API\Model\ContentCreateManyRequest::class => false, \PicturePark\API\Model\ContentMetadataUpdateManyRequest::class => false, \PicturePark\API\Model\ContentMetadataUpdateItem::class => false, \PicturePark\API\Model\ContentPermissionsUpdateManyRequest::class => false, \PicturePark\API\Model\ContentPermissionsUpdateItem::class => false, \PicturePark\API\Model\ContentOwnershipTransferManyRequest::class => false, \PicturePark\API\Model\ContentOwnershipTransferItem::class => false, \PicturePark\API\Model\ContentDeleteManyRequest::class => false, \PicturePark\API\Model\ContentDeleteManyFilterRequest::class => false, \PicturePark\API\Model\ContentFilterRequest::class => false, \PicturePark\API\Model\ContentRestoreManyRequest::class => false, \PicturePark\API\Model\ContentManyReferencesRequest::class => false, \PicturePark\API\Model\OutputResolveManyRequest::class => false, \PicturePark\API\Model\ContentFieldsBatchUpdateRequest::class => false, \PicturePark\API\Model\MetadataValuesChangeRequestBase::class => false, \PicturePark\API\Model\MetadataValuesChangeCommandBase::class => false, \PicturePark\API\Model\MetadataValuesSchemaUpdateCommand::class => false, \PicturePark\API\Model\MetadataValuesSchemaUpsertCommand::class => false, \PicturePark\API\Model\MetadataValuesSchemaRemoveCommand::class => false, \PicturePark\API\Model\MetadataValuesSchemaReplaceCommand::class => false, \PicturePark\API\Model\MetadataValuesFieldRemoveCommand::class => false, \PicturePark\API\Model\MetadataValuesSchemaItemAddCommand::class => false, \PicturePark\API\Model\MetadataValuesSchemaItemRemoveCommand::class => false, \PicturePark\API\Model\ContentFieldsBatchUpdateFilterRequest::class => false, \PicturePark\API\Model\ContentSearchResult::class => false, \PicturePark\API\Model\ContentRightAggregationCount::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfContent::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfContent::class => false, \PicturePark\API\Model\BaseResultOfContent::class => false, \PicturePark\API\Model\Content::class => false, \PicturePark\API\Model\ContentSearchRequest::class => false, \PicturePark\API\Model\ContentAggregationOnChannelRequest::class => false, \PicturePark\API\Model\ObjectAggregationResult::class => false, \PicturePark\API\Model\ContentAggregationRequest::class => false, \PicturePark\API\Model\DisplayValueStatus::class => false, \PicturePark\API\Model\DocumentHistory::class => false, \PicturePark\API\Model\UserAuditHistory::class => false, \PicturePark\API\Model\DocumentHistoryDifference::class => false, \PicturePark\API\Model\DocumentHistorySearchResult::class => false, \PicturePark\API\Model\BaseResultOfDocumentHistory::class => false, \PicturePark\API\Model\DocumentHistorySearchRequest::class => false, \PicturePark\API\Model\IdentityProvider::class => false, \PicturePark\API\Model\IdentityProviderEditable::class => false, \PicturePark\API\Model\IdpClaimToUserAttributeMapping::class => false, \PicturePark\API\Model\IdpGroupToUserRoleMapping::class => false, \PicturePark\API\Model\IdentityProviderBasicInfo::class => false, \PicturePark\API\Model\VersionInfo::class => false, \PicturePark\API\Model\CustomerInfo::class => false, \PicturePark\API\Model\LanguageConfiguration::class => false, \PicturePark\API\Model\Language::class => false, \PicturePark\API\Model\OutputFormatInfo::class => false, \PicturePark\API\Model\CustomerApp::class => false, \PicturePark\API\Model\SystemStatus::class => false, \PicturePark\API\Model\StatusOfSearchIndexState::class => false, \PicturePark\API\Model\StatusOfDisplayValuesState::class => false, \PicturePark\API\Model\StatusOfMetadataState::class => false, \PicturePark\API\Model\ListItemDetail::class => false, \PicturePark\API\Model\ListItemUpdateRequest::class => false, \PicturePark\API\Model\ListItemReferencesResult::class => false, \PicturePark\API\Model\ListItemReferencesRequest::class => false, \PicturePark\API\Model\ListItemCreateRequest::class => false, \PicturePark\API\Model\ListItemCreateManyRequest::class => false, \PicturePark\API\Model\ListItemUpdateManyRequest::class => false, \PicturePark\API\Model\ListItemUpdateItem::class => false, \PicturePark\API\Model\ListItemDeleteManyRequest::class => false, \PicturePark\API\Model\ListItemDeleteManyFilterRequest::class => false, \PicturePark\API\Model\ListItemFilterRequest::class => false, \PicturePark\API\Model\ListItemRestoreManyRequest::class => false, \PicturePark\API\Model\ListItemManyReferencesRequest::class => false, \PicturePark\API\Model\ListItemFieldsBatchUpdateRequest::class => false, \PicturePark\API\Model\ListItemFieldsBatchUpdateFilterRequest::class => false, \PicturePark\API\Model\ListItemSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfListItem::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfListItem::class => false, \PicturePark\API\Model\BaseResultOfListItem::class => false, \PicturePark\API\Model\ListItem::class => false, \PicturePark\API\Model\ListItemSearchRequest::class => false, \PicturePark\API\Model\ListItemSearchAndAggregationBaseRequest::class => false, \PicturePark\API\Model\ListItemAggregationRequest::class => false, \PicturePark\API\Model\LiveStreamSearchResult::class => false, \PicturePark\API\Model\BaseResultOfLiveStream::class => false, \PicturePark\API\Model\LiveStream::class => false, \PicturePark\API\Model\LiveStreamTraceJob::class => false, \PicturePark\API\Model\LiveStreamSearchRequest::class => false, \PicturePark\API\Model\MetadataStatus::class => false, \PicturePark\API\Model\OutputFormatDownloadFileNamePatternUpdateManyRequest::class => false, \PicturePark\API\Model\OutputFormatDownloadFileNamePatternUpdateRequestItem::class => false, \PicturePark\API\Model\OutputFormatSetXmpWritebackStateRequest::class => false, \PicturePark\API\Model\OutputFormatSetXmpWritebackStateManyRequest::class => false, \PicturePark\API\Model\OutputFormatSetXmpWritebackStateRequestItem::class => false, \PicturePark\API\Model\OutputFormatRenderPreviewRequest::class => false, \PicturePark\API\Model\OutputFormatRenderingSpecification::class => false, \PicturePark\API\Model\SourceOutputFormats::class => false, \PicturePark\API\Model\FormatBase::class => false, \PicturePark\API\Model\ImageFormatBase::class => false, \PicturePark\API\Model\ResizeAction::class => false, \PicturePark\API\Model\ImageActionBase::class => false, \PicturePark\API\Model\AlphaHandlingAction::class => false, \PicturePark\API\Model\CropAction::class => false, \PicturePark\API\Model\UnsharpenMaskAction::class => false, \PicturePark\API\Model\WatermarkAction::class => false, \PicturePark\API\Model\OriginalFormat::class => false, \PicturePark\API\Model\JpegFormat::class => false, \PicturePark\API\Model\PngFormat::class => false, \PicturePark\API\Model\TiffFormat::class => false, \PicturePark\API\Model\VideoFormatBase::class => false, \PicturePark\API\Model\Mp4VideoFormat::class => false, \PicturePark\API\Model\AudioFormatBase::class => false, \PicturePark\API\Model\VideoSpriteFormat::class => false, \PicturePark\API\Model\VideoStillFormat::class => false, \PicturePark\API\Model\AacAudioFormat::class => false, \PicturePark\API\Model\AudioStillFormat::class => false, \PicturePark\API\Model\Mp3AudioFormat::class => false, \PicturePark\API\Model\DocumentFormatBase::class => false, \PicturePark\API\Model\DocumentStillFormat::class => false, \PicturePark\API\Model\PdfFormat::class => false, \PicturePark\API\Model\VectorFormatBase::class => false, \PicturePark\API\Model\SvgFormat::class => false, \PicturePark\API\Model\VectorStillFormat::class => false, \PicturePark\API\Model\OutputFormatDetail::class => false, \PicturePark\API\Model\OutputFormat::class => false, \PicturePark\API\Model\OutputFormatEditable::class => false, \PicturePark\API\Model\OutputFormatCreateManyRequest::class => false, \PicturePark\API\Model\OutputFormatUpdateManyRequest::class => false, \PicturePark\API\Model\OutputFormatUpdateManyRequestItem::class => false, \PicturePark\API\Model\OutputFormatDeleteManyRequest::class => false, \PicturePark\API\Model\OutputSearchResult::class => false, \PicturePark\API\Model\BaseResultOfOutput::class => false, \PicturePark\API\Model\OutputSearchRequest::class => false, \PicturePark\API\Model\OutputResetRetryAttemptsRequest::class => false, \PicturePark\API\Model\UserProfile::class => false, \PicturePark\API\Model\UserAddress::class => false, \PicturePark\API\Model\UserProfileUpdateRequest::class => false, \PicturePark\API\Model\SchemaPermissionSetDetail::class => false, \PicturePark\API\Model\PermissionSetDetailOfMetadataRight::class => false, \PicturePark\API\Model\PermissionUserRoleRightsOfMetadataRight::class => false, \PicturePark\API\Model\SchemaPermissionSetCreateRequest::class => false, \PicturePark\API\Model\PermissionSetCreateRequestOfMetadataRight::class => false, \PicturePark\API\Model\UserRoleRightsOfMetadataRight::class => false, \PicturePark\API\Model\SchemaPermissionSetUpdateRequest::class => false, \PicturePark\API\Model\PermissionSetUpdateRequestOfMetadataRight::class => false, \PicturePark\API\Model\SchemaPermissionSetCreateManyRequest::class => false, \PicturePark\API\Model\SchemaPermissionSetUpdateManyRequest::class => false, \PicturePark\API\Model\SchemaPermissionSetUpdateRequestItem::class => false, \PicturePark\API\Model\PermissionSetUpdateRequestItemOfMetadataRight::class => false, \PicturePark\API\Model\SchemaDetail::class => false, \PicturePark\API\Model\DisplayPattern::class => false, \PicturePark\API\Model\FieldBase::class => false, \PicturePark\API\Model\FieldBoolean::class => false, \PicturePark\API\Model\FieldDate::class => false, \PicturePark\API\Model\FieldDateTime::class => false, \PicturePark\API\Model\FieldDateTimeArray::class => false, \PicturePark\API\Model\FieldDecimal::class => false, \PicturePark\API\Model\FieldDictionary::class => false, \PicturePark\API\Model\FieldDictionaryArray::class => false, \PicturePark\API\Model\FieldGeoPoint::class => false, \PicturePark\API\Model\FieldTrigger::class => false, \PicturePark\API\Model\FieldLong::class => false, \PicturePark\API\Model\FieldLongArray::class => false, \PicturePark\API\Model\FieldSingleFieldset::class => false, \PicturePark\API\Model\SchemaIndexingInfo::class => false, \PicturePark\API\Model\FieldIndexingInfo::class => false, \PicturePark\API\Model\FieldMultiFieldset::class => false, \PicturePark\API\Model\FieldSingleTagbox::class => false, \PicturePark\API\Model\FieldMultiTagbox::class => false, \PicturePark\API\Model\FieldString::class => false, \PicturePark\API\Model\AnalyzerBase::class => false, \PicturePark\API\Model\EdgeNGramAnalyzer::class => false, \PicturePark\API\Model\LanguageAnalyzer::class => false, \PicturePark\API\Model\NGramAnalyzer::class => false, \PicturePark\API\Model\PathHierarchyAnalyzer::class => false, \PicturePark\API\Model\SimpleAnalyzer::class => false, \PicturePark\API\Model\FieldStringArray::class => false, \PicturePark\API\Model\FieldTranslatedString::class => false, \PicturePark\API\Model\FieldSingleRelation::class => false, \PicturePark\API\Model\RelationType::class => false, \PicturePark\API\Model\FieldMultiRelation::class => false, \PicturePark\API\Model\FieldOverwriteBase::class => false, \PicturePark\API\Model\FieldOverwriteSingleTagbox::class => false, \PicturePark\API\Model\FieldOverwriteMultiTagbox::class => false, \PicturePark\API\Model\SearchFieldCount::class => false, \PicturePark\API\Model\SchemaExistsResponse::class => false, \PicturePark\API\Model\FieldExistsResponse::class => false, \PicturePark\API\Model\SchemaUpdateResult::class => false, \PicturePark\API\Model\SchemaUpdateRequest::class => false, \PicturePark\API\Model\SchemaOwnershipTransferRequest::class => false, \PicturePark\API\Model\SchemaCreateResult::class => false, \PicturePark\API\Model\SchemaCreateRequest::class => false, \PicturePark\API\Model\SchemaCreateManyRequest::class => false, \PicturePark\API\Model\SchemaUpdateManyRequest::class => false, \PicturePark\API\Model\SchemaUpdateItem::class => false, \PicturePark\API\Model\SchemaOwnershipTransferManyRequest::class => false, \PicturePark\API\Model\SchemaSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfSchema::class => false, \PicturePark\API\Model\BaseResultOfSchema::class => false, \PicturePark\API\Model\Schema::class => false, \PicturePark\API\Model\SchemaSearchRequest::class => false, \PicturePark\API\Model\IndexField::class => false, \PicturePark\API\Model\IndexFieldsSearchBySchemaIdsRequest::class => false, \PicturePark\API\Model\Transfer::class => false, \PicturePark\API\Model\SchemaImportRequest::class => false, \PicturePark\API\Model\ShareDetail::class => false, \PicturePark\API\Model\ShareUser::class => false, \PicturePark\API\Model\ShareContentDetail::class => false, \PicturePark\API\Model\ShareOutputBase::class => false, \PicturePark\API\Model\ShareOutputBasic::class => false, \PicturePark\API\Model\ShareOutputEmbed::class => false, \PicturePark\API\Model\ShareDataBase::class => false, \PicturePark\API\Model\ShareDataEmbed::class => false, \PicturePark\API\Model\ShareDataBasic::class => false, \PicturePark\API\Model\MailRecipient::class => false, \PicturePark\API\Model\UserEmail::class => false, \PicturePark\API\Model\InternalRecipient::class => false, \PicturePark\API\Model\ShareBaseUpdateRequest::class => false, \PicturePark\API\Model\ShareContent::class => false, \PicturePark\API\Model\ShareBasicUpdateRequest::class => false, \PicturePark\API\Model\ShareEmbedUpdateRequest::class => false, \PicturePark\API\Model\ShareBaseCreateRequest::class => false, \PicturePark\API\Model\ShareBasicCreateRequest::class => false, \PicturePark\API\Model\ShareEmbedCreateRequest::class => false, \PicturePark\API\Model\ShareDeleteManyRequest::class => false, \PicturePark\API\Model\ShareRevokeManyRequest::class => false, \PicturePark\API\Model\ShareAggregationRequest::class => false, \PicturePark\API\Model\ShareSearchAndAggregationBaseRequest::class => false, \PicturePark\API\Model\ShareSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfShare::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfShare::class => false, \PicturePark\API\Model\BaseResultOfShare::class => false, \PicturePark\API\Model\Share::class => false, \PicturePark\API\Model\ShareSearchRequest::class => false, \PicturePark\API\Model\CreateTransferRequest::class => false, \PicturePark\API\Model\TransferUploadFile::class => false, \PicturePark\API\Model\TransferFile::class => false, \PicturePark\API\Model\TransferWebLink::class => false, \PicturePark\API\Model\TransferDetail::class => false, \PicturePark\API\Model\ImportTransferRequest::class => false, \PicturePark\API\Model\ImportTransferPartialRequest::class => false, \PicturePark\API\Model\FileTransferCreateItem::class => false, \PicturePark\API\Model\TransferSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfTransfer::class => false, \PicturePark\API\Model\BaseResultOfTransfer::class => false, \PicturePark\API\Model\TransferSearchRequest::class => false, \PicturePark\API\Model\FileTransferDetail::class => false, \PicturePark\API\Model\FileMetadata::class => false, \PicturePark\API\Model\FileTransferOutput::class => false, \PicturePark\API\Model\FileTransfer::class => false, \PicturePark\API\Model\FileTransferSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfFileTransfer::class => false, \PicturePark\API\Model\BaseResultOfFileTransfer::class => false, \PicturePark\API\Model\FileTransferSearchRequest::class => false, \PicturePark\API\Model\FileTransferDeleteRequest::class => false, \PicturePark\API\Model\Blacklist::class => false, \PicturePark\API\Model\BlacklistItem::class => false, \PicturePark\API\Model\UserRoleSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfUserRole::class => false, \PicturePark\API\Model\BaseResultOfUserRole::class => false, \PicturePark\API\Model\UserRole::class => false, \PicturePark\API\Model\UserRoleEditable::class => false, \PicturePark\API\Model\UserRoleSearchRequest::class => false, \PicturePark\API\Model\UserRoleDetail::class => false, \PicturePark\API\Model\UserRoleCreateManyRequest::class => false, \PicturePark\API\Model\UserRoleCreateRequest::class => false, \PicturePark\API\Model\UserRoleUpdateManyRequest::class => false, \PicturePark\API\Model\UserRoleDeleteManyRequest::class => false, \PicturePark\API\Model\UserDetail::class => false, \PicturePark\API\Model\UserRoleAssignment::class => false, \PicturePark\API\Model\OwnerToken::class => false, \PicturePark\API\Model\UserUpdateRequest::class => false, \PicturePark\API\Model\UserLockRequest::class => false, \PicturePark\API\Model\UserLockManyRequest::class => false, \PicturePark\API\Model\UserManyRequestBase::class => false, \PicturePark\API\Model\UserReviewRequest::class => false, \PicturePark\API\Model\UserReviewManyRequest::class => false, \PicturePark\API\Model\UserInviteManyRequest::class => false, \PicturePark\API\Model\UserReinviteManyRequest::class => false, \PicturePark\API\Model\UserRoleAssignManyRequest::class => false, \PicturePark\API\Model\UserDeleteRequest::class => false, \PicturePark\API\Model\UserCreateRequest::class => false, \PicturePark\API\Model\UserSearchResult::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfUserWithRoles::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfUserWithRoles::class => false, \PicturePark\API\Model\BaseResultOfUserWithRoles::class => false, \PicturePark\API\Model\UserWithRoles::class => false, \PicturePark\API\Model\UserSearchRequest::class => false, \PicturePark\API\Model\UserSearchAndAggregationBaseRequest::class => false, \PicturePark\API\Model\UserAggregationRequest::class => false, \PicturePark\API\Model\UserUpdateIdentityProviderManyRequest::class => false, \PicturePark\API\Model\XmpMappingTargets::class => false, \PicturePark\API\Model\XmpField::class => false, \PicturePark\API\Model\MetadataField::class => false, \PicturePark\API\Model\XmpMappingEntrySearchResult::class => false, \PicturePark\API\Model\SearchBehaviorWithAggregationBaseResultOfXmpMappingEntry::class => false, \PicturePark\API\Model\SearchBehaviorBaseResultOfXmpMappingEntry::class => false, \PicturePark\API\Model\BaseResultOfXmpMappingEntry::class => false, \PicturePark\API\Model\XmpMappingEntry::class => false, \PicturePark\API\Model\XmpMappingEntryEditable::class => false, \PicturePark\API\Model\XmpMappingEntryConfigurationBase::class => false, \PicturePark\API\Model\XmpMappingEntryConfigurationTagbox::class => false, \PicturePark\API\Model\XmpMappingEntrySearchRequest::class => false, \PicturePark\API\Model\XmpMappingEntryCreateRequest::class => false, \PicturePark\API\Model\XmpMappingEntryCreateManyRequest::class => false, \PicturePark\API\Model\XmpMappingEntryUpdateManyRequest::class => false, \PicturePark\API\Model\XmpMappingEntryDeleteManyRequest::class => false, \PicturePark\API\Model\LiveStreamMessage::class => false, \PicturePark\API\Model\DocumentChange::class => false, \PicturePark\API\Model\ApplicationEvent::class => false, \PicturePark\API\Model\TransferEvent::class => false, \PicturePark\API\Model\ReindexEvent::class => false, \PicturePark\API\Model\ContentDetailViewEvent::class => false, \PicturePark\API\Model\ContentDownloadEvent::class => false, \PicturePark\API\Model\DownloadTrackingInfo::class => false, \PicturePark\API\Model\SessionRenewalEvent::class => false, \PicturePark\API\Model\SharePageViewEvent::class => false, \PicturePark\API\Model\ApiStatisticsEvent::class => false, \PicturePark\API\Model\BusinessProcessEvent::class => false, \PicturePark\API\Model\OutputRenderedEvent::class => false, \PicturePark\API\Model\ConfigurationChangeEvent::class => false, \PicturePark\API\Model\CustomerChangeEvent::class => false, \PicturePark\API\Model\SearchReindexCompletedEvent::class => false, \PicturePark\API\Model\BusinessRuleFiredEvent::class => false, \PicturePark\API\Model\BusinessRuleFiredEventDetail::class => false, \PicturePark\API\Model\BusinessProcessCancellationRequestedEvent::class => false, \PicturePark\API\Model\XmpWritebackCompletedEvent::class => false, \PicturePark\API\Model\Message::class => false, \PicturePark\API\Model\ConsoleMessage::class => false, \PicturePark\API\Model\TupleOfStringAndString::class => false, \PicturePark\API\Model\NodeInfoMessage::class => false, \PicturePark\API\Model\AudioMetadata::class => false, \PicturePark\API\Model\AudioStream::class => false, \PicturePark\API\Model\DocumentMetadata::class => false, \PicturePark\API\Model\EpsMetadata::class => false, \PicturePark\API\Model\ImageMetadata::class => false, \PicturePark\API\Model\VideoMetadata::class => false, \PicturePark\API\Model\VideoStream::class => false, \PicturePark\API\Model\VectorMetadata::class => false, \Jane\Component\JsonSchemaRuntime\Reference::class => false];
        }
    }
} else {
    class JaneObjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
