...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DuplicateMetadataDisplayPatternExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DuplicateMetadataDisplayPatternException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\DuplicateMetadataDisplayPatternException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\DuplicateMetadataDisplayPatternException();
            ...
            if (\array_key_exists('displayPatternId', $data) && $data['displayPatternId'] !== null) {
                $object->setDisplayPatternId($data['displayPatternId']);
                unset($data['displayPatternId']);
            }
            elseif (\array_key_exists('displayPatternId', $data) && $data['displayPatternId'] === null) {
                $object->setDisplayPatternId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('displayPatternId') && null !== $object->getDisplayPatternId()) {
                $data['displayPatternId'] = $object->getDisplayPatternId();
            }
        ...
        {
            return [\PicturePark\API\Model\DuplicateMetadataDisplayPatternException::class => false];
        }
    }
} else {
    class DuplicateMetadataDisplayPatternExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
