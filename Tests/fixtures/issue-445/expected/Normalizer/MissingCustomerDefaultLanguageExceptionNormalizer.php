...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class MissingCustomerDefaultLanguageExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\MissingCustomerDefaultLanguageException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\MissingCustomerDefaultLanguageException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\MissingCustomerDefaultLanguageException();
            ...
            if (\array_key_exists('customerDefaultLanguage', $data) && $data['customerDefaultLanguage'] !== null) {
                $object->setCustomerDefaultLanguage($data['customerDefaultLanguage']);
                unset($data['customerDefaultLanguage']);
            }
            elseif (\array_key_exists('customerDefaultLanguage', $data) && $data['customerDefaultLanguage'] === null) {
                $object->setCustomerDefaultLanguage(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('customerDefaultLanguage') && null !== $object->getCustomerDefaultLanguage()) {
                $data['customerDefaultLanguage'] = $object->getCustomerDefaultLanguage();
            }
        ...
        {
            return [\PicturePark\API\Model\MissingCustomerDefaultLanguageException::class => false];
        }
    }
} else {
    class MissingCustomerDefaultLanguageExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
