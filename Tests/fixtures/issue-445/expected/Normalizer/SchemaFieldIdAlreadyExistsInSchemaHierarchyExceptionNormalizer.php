...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldIdAlreadyExistsInSchemaHierarchyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldIdAlreadyExistsInSchemaHierarchyException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldIdAlreadyExistsInSchemaHierarchyException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldIdAlreadyExistsInSchemaHierarchyException();
            ...
            if (\array_key_exists('existingInSchemaId', $data) && $data['existingInSchemaId'] !== null) {
                $object->setExistingInSchemaId($data['existingInSchemaId']);
                unset($data['existingInSchemaId']);
            }
            elseif (\array_key_exists('existingInSchemaId', $data) && $data['existingInSchemaId'] === null) {
                $object->setExistingInSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('existingInSchemaId') && null !== $object->getExistingInSchemaId()) {
                $data['existingInSchemaId'] = $object->getExistingInSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldIdAlreadyExistsInSchemaHierarchyException::class => false];
        }
    }
} else {
    class SchemaFieldIdAlreadyExistsInSchemaHierarchyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
