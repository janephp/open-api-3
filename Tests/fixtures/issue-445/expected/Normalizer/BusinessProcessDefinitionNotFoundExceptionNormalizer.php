...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessProcessDefinitionNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\BusinessProcessDefinitionNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\BusinessProcessDefinitionNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\BusinessProcessDefinitionNotFoundException();
            ...
            if (\array_key_exists('processDefinitionId', $data) && $data['processDefinitionId'] !== null) {
                $object->setProcessDefinitionId($data['processDefinitionId']);
                unset($data['processDefinitionId']);
            }
            elseif (\array_key_exists('processDefinitionId', $data) && $data['processDefinitionId'] === null) {
                $object->setProcessDefinitionId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('processDefinitionId') && null !== $object->getProcessDefinitionId()) {
        ...
        {
            return [\PicturePark\API\Model\BusinessProcessDefinitionNotFoundException::class => false];
        }
    }
} else {
    class BusinessProcessDefinitionNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
