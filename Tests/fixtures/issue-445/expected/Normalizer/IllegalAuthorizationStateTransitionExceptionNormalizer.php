...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class IllegalAuthorizationStateTransitionExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\IllegalAuthorizationStateTransitionException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\IllegalAuthorizationStateTransitionException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\IllegalAuthorizationStateTransitionException();
            ...
            if (\array_key_exists('requestedUserId', $data) && $data['requestedUserId'] !== null) {
                $object->setRequestedUserId($data['requestedUserId']);
                unset($data['requestedUserId']);
            }
            elseif (\array_key_exists('requestedUserId', $data) && $data['requestedUserId'] === null) {
                $object->setRequestedUserId(null);
            }
            ...
            if (\array_key_exists('transition', $data) && $data['transition'] !== null) {
                $object->setTransition($data['transition']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('requestedUserId') && null !== $object->getRequestedUserId()) {
                $data['requestedUserId'] = $object->getRequestedUserId();
            }
            ...
            if ($object->isInitialized('transition') && null !== $object->getTransition()) {
                $data['transition'] = $object->getTransition();
            }
        ...
        {
            return [\PicturePark\API\Model\IllegalAuthorizationStateTransitionException::class => false];
        }
    }
} else {
    class IllegalAuthorizationStateTransitionExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
