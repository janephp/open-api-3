...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class MissingDisplayPatternForCustomerDefaultLanguageExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\MissingDisplayPatternForCustomerDefaultLanguageException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\MissingDisplayPatternForCustomerDefaultLanguageException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\MissingDisplayPatternForCustomerDefaultLanguageException();
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('missingTypes') && null !== $object->getMissingTypes()) {
                $values = [];
                foreach ($object->getMissingTypes() as $value) {
                    $values[] = $value;
                }
                $data['missingTypes'] = $values;
            }
        ...
        {
            return [\PicturePark\API\Model\MissingDisplayPatternForCustomerDefaultLanguageException::class => false];
        }
    }
} else {
    class MissingDisplayPatternForCustomerDefaultLanguageExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
