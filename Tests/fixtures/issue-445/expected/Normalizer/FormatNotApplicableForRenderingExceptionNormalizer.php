...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FormatNotApplicableForRenderingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\FormatNotApplicableForRenderingException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\FormatNotApplicableForRenderingException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\FormatNotApplicableForRenderingException();
            ...
            if (\array_key_exists('contentRenderingType', $data)) {
                $object->setContentRenderingType($data['contentRenderingType']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('contentRenderingType') && null !== $object->getContentRenderingType()) {
                $data['contentRenderingType'] = $object->getContentRenderingType();
            }
        ...
        {
            return [\PicturePark\API\Model\FormatNotApplicableForRenderingException::class => false];
        }
    }
} else {
    class FormatNotApplicableForRenderingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
