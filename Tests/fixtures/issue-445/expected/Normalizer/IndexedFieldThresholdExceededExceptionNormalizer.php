...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class IndexedFieldThresholdExceededExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\IndexedFieldThresholdExceededException::class;
        }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('indexedFieldCount') && null !== $object->getIndexedFieldCount()) {
                $data['indexedFieldCount'] = $object->getIndexedFieldCount();
            }
            if ($object->isInitialized('indexedFieldThreshold') && null !== $object->getIndexedFieldThreshold()) {
