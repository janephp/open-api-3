...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AggregationFilterNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\AggregationFilterNotSupportedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\AggregationFilterNotSupportedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\AggregationFilterNotSupportedException();
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('notSupportedFilterType') && null !== $object->getNotSupportedFilterType()) {
                $data['notSupportedFilterType'] = $object->getNotSupportedFilterType();
            }
            if ($object->isInitialized('supportedFilterTypes') && null !== $object->getSupportedFilterTypes()) {
                $values = [];
                foreach ($object->getSupportedFilterTypes() as $value) {
                    $values[] = $value;
                }
        ...
        {
            return [\PicturePark\API\Model\AggregationFilterNotSupportedException::class => false];
        }
    }
} else {
    class AggregationFilterNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
