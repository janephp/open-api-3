...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DuplicatedItemAssignedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DuplicatedItemAssignedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\DuplicatedItemAssignedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\DuplicatedItemAssignedException();
            ...
            if (\array_key_exists('itemPath', $data) && $data['itemPath'] !== null) {
                $object->setItemPath($data['itemPath']);
                unset($data['itemPath']);
            }
            elseif (\array_key_exists('itemPath', $data) && $data['itemPath'] === null) {
                $object->setItemPath(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('itemPath') && null !== $object->getItemPath()) {
                $data['itemPath'] = $object->getItemPath();
            }
        ...
        {
            return [\PicturePark\API\Model\DuplicatedItemAssignedException::class => false];
        }
    }
} else {
    class DuplicatedItemAssignedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
