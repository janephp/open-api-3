...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class RetryExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\RetryException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\RetryException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\RetryException();
            ...
            if (\array_key_exists('innerExceptionDetail', $data) && $data['innerExceptionDetail'] !== null) {
                $object->setInnerExceptionDetail($data['innerExceptionDetail']);
                unset($data['innerExceptionDetail']);
            }
            elseif (\array_key_exists('innerExceptionDetail', $data) && $data['innerExceptionDetail'] === null) {
                $object->setInnerExceptionDetail(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('innerExceptionDetail') && null !== $object->getInnerExceptionDetail()) {
                $data['innerExceptionDetail'] = $object->getInnerExceptionDetail();
            }
        ...
        {
            return [\PicturePark\API\Model\RetryException::class => false];
        }
    }
} else {
    class RetryExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
