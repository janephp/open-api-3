...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class IndexMappingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\IndexMappingException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\IndexMappingException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\IndexMappingException();
            ...
            if (\array_key_exists('indexName', $data) && $data['indexName'] !== null) {
                $object->setIndexName($data['indexName']);
                unset($data['indexName']);
            }
            elseif (\array_key_exists('indexName', $data) && $data['indexName'] === null) {
                $object->setIndexName(null);
            }
            if (\array_key_exists('debugInformation', $data) && $data['debugInformation'] !== null) {
                $object->setDebugInformation($data['debugInformation']);
                unset($data['debugInformation']);
            }
            elseif (\array_key_exists('debugInformation', $data) && $data['debugInformation'] === null) {
                $object->setDebugInformation(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('indexName') && null !== $object->getIndexName()) {
                $data['indexName'] = $object->getIndexName();
            }
            if ($object->isInitialized('debugInformation') && null !== $object->getDebugInformation()) {
                $data['debugInformation'] = $object->getDebugInformation();
            }
        ...
        {
            return [\PicturePark\API\Model\IndexMappingException::class => false];
        }
    }
} else {
    class IndexMappingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
