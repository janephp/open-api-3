...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OwnerTokenInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\OwnerTokenInUseException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\OwnerTokenInUseException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\OwnerTokenInUseException();
            ...
            if (\array_key_exists('ownerTokenUserId', $data) && $data['ownerTokenUserId'] !== null) {
                $object->setOwnerTokenUserId($data['ownerTokenUserId']);
                unset($data['ownerTokenUserId']);
            }
            elseif (\array_key_exists('ownerTokenUserId', $data) && $data['ownerTokenUserId'] === null) {
                $object->setOwnerTokenUserId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('ownerTokenUserId') && null !== $object->getOwnerTokenUserId()) {
                $data['ownerTokenUserId'] = $object->getOwnerTokenUserId();
            }
        ...
        {
            return [\PicturePark\API\Model\OwnerTokenInUseException::class => false];
        }
    }
} else {
    class OwnerTokenInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
