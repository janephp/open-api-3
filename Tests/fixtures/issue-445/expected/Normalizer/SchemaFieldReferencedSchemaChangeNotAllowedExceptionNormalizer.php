...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldReferencedSchemaChangeNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldReferencedSchemaChangeNotAllowedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldReferencedSchemaChangeNotAllowedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldReferencedSchemaChangeNotAllowedException();
            ...
            if (\array_key_exists('oldReferencedSchemaId', $data) && $data['oldReferencedSchemaId'] !== null) {
                $object->setOldReferencedSchemaId($data['oldReferencedSchemaId']);
                unset($data['oldReferencedSchemaId']);
            }
            elseif (\array_key_exists('oldReferencedSchemaId', $data) && $data['oldReferencedSchemaId'] === null) {
                $object->setOldReferencedSchemaId(null);
            }
            if (\array_key_exists('newReferencedSchemaId', $data) && $data['newReferencedSchemaId'] !== null) {
                $object->setNewReferencedSchemaId($data['newReferencedSchemaId']);
                unset($data['newReferencedSchemaId']);
            }
            elseif (\array_key_exists('newReferencedSchemaId', $data) && $data['newReferencedSchemaId'] === null) {
                $object->setNewReferencedSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('oldReferencedSchemaId') && null !== $object->getOldReferencedSchemaId()) {
                $data['oldReferencedSchemaId'] = $object->getOldReferencedSchemaId();
            }
            if ($object->isInitialized('newReferencedSchemaId') && null !== $object->getNewReferencedSchemaId()) {
                $data['newReferencedSchemaId'] = $object->getNewReferencedSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldReferencedSchemaChangeNotAllowedException::class => false];
        }
    }
} else {
    class SchemaFieldReferencedSchemaChangeNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
