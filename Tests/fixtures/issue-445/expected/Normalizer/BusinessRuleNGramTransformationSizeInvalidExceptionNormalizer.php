...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleNGramTransformationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\BusinessRuleNGramTransformationSizeInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\BusinessRuleNGramTransformationSizeInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\BusinessRuleNGramTransformationSizeInvalidException();
            ...
            if (\array_key_exists('minSize', $data)) {
                $object->setMinSize($data['minSize']);
                unset($data['minSize']);
            }
        ...
        {
            return [\PicturePark\API\Model\BusinessRuleNGramTransformationSizeInvalidException::class => false];
        }
    }
} else {
    class BusinessRuleNGramTransformationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
