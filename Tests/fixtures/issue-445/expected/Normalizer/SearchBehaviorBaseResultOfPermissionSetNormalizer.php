...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SearchBehaviorBaseResultOfPermissionSetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SearchBehaviorBaseResultOfPermissionSet::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SearchBehaviorBaseResultOfPermissionSet::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SearchBehaviorBaseResultOfPermissionSet();
            ...
            if (\array_key_exists('results', $data)) {
                ...
                foreach ($data['results'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \PicturePark\API\Model\PermissionSet::class, 'json', $context);
                }
        ...
        {
            return [\PicturePark\API\Model\SearchBehaviorBaseResultOfPermissionSet::class => false];
        }
    }
} else {
    class SearchBehaviorBaseResultOfPermissionSetNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
