...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ActivityMappingInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ActivityMappingInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ActivityMappingInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\ActivityMappingInvalidException();
            ...
            if (\array_key_exists('activityMapping', $data) && $data['activityMapping'] !== null) {
                $object->setActivityMapping($data['activityMapping']);
                unset($data['activityMapping']);
            }
            elseif (\array_key_exists('activityMapping', $data) && $data['activityMapping'] === null) {
                $object->setActivityMapping(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('activityMapping') && null !== $object->getActivityMapping()) {
                $data['activityMapping'] = $object->getActivityMapping();
            }
        ...
        {
            return [\PicturePark\API\Model\ActivityMappingInvalidException::class => false];
        }
    }
} else {
    class ActivityMappingInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
