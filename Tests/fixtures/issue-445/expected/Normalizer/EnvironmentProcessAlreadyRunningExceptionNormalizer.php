...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class EnvironmentProcessAlreadyRunningExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\EnvironmentProcessAlreadyRunningException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\EnvironmentProcessAlreadyRunningException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\EnvironmentProcessAlreadyRunningException();
            ...
            if (\array_key_exists('environmentProcessType', $data)) {
                $object->setEnvironmentProcessType($data['environmentProcessType']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('environmentProcessType') && null !== $object->getEnvironmentProcessType()) {
                $data['environmentProcessType'] = $object->getEnvironmentProcessType();
            }
        ...
        {
            return [\PicturePark\API\Model\EnvironmentProcessAlreadyRunningException::class => false];
        }
    }
} else {
    class EnvironmentProcessAlreadyRunningExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
