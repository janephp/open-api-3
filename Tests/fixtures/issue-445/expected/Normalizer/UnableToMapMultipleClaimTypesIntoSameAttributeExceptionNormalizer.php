...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UnableToMapMultipleClaimTypesIntoSameAttributeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\UnableToMapMultipleClaimTypesIntoSameAttributeException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\UnableToMapMultipleClaimTypesIntoSameAttributeException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\UnableToMapMultipleClaimTypesIntoSameAttributeException();
            ...
            if (\array_key_exists('attributePath', $data) && $data['attributePath'] !== null) {
                $object->setAttributePath($data['attributePath']);
                unset($data['attributePath']);
            }
            elseif (\array_key_exists('attributePath', $data) && $data['attributePath'] === null) {
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('attributePath') && null !== $object->getAttributePath()) {
                $data['attributePath'] = $object->getAttributePath();
            }
        ...
        {
            return [\PicturePark\API\Model\UnableToMapMultipleClaimTypesIntoSameAttributeException::class => false];
        }
    }
} else {
    class UnableToMapMultipleClaimTypesIntoSameAttributeExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
