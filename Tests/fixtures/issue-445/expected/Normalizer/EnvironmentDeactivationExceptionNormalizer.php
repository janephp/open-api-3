...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class EnvironmentDeactivationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\EnvironmentDeactivationException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\EnvironmentDeactivationException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\EnvironmentDeactivationException();
            ...
            if (\array_key_exists('deactivationMessage', $data) && $data['deactivationMessage'] !== null) {
                $object->setDeactivationMessage($data['deactivationMessage']);
                unset($data['deactivationMessage']);
            }
            elseif (\array_key_exists('deactivationMessage', $data) && $data['deactivationMessage'] === null) {
                $object->setDeactivationMessage(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('deactivationMessage') && null !== $object->getDeactivationMessage()) {
                $data['deactivationMessage'] = $object->getDeactivationMessage();
            }
        ...
        {
            return [\PicturePark\API\Model\EnvironmentDeactivationException::class => false];
        }
    }
} else {
    class EnvironmentDeactivationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
