...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldRelationTargetDocTypeModificationNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldRelationTargetDocTypeModificationNotAllowedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldRelationTargetDocTypeModificationNotAllowedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldRelationTargetDocTypeModificationNotAllowedException();
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldRelationTargetDocTypeModificationNotAllowedException::class => false];
        }
    }
} else {
    class SchemaFieldRelationTargetDocTypeModificationNotAllowedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
