...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaImportVersionMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return is_object($data) && get_class($data) === 'PicturePark\\API\\Model\\SchemaImportVersionMismatchException';
        }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('providedVersion') && null !== $object->getProvidedVersion()) {
                $data['providedVersion'] = $object->getProvidedVersion();
            }
