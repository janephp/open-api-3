...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldDisplayPatternTypeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldDisplayPatternTypeNotSupportedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldDisplayPatternTypeNotSupportedException();
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('displayPatternType') && null !== $object->getDisplayPatternType()) {
                $data['displayPatternType'] = $object->getDisplayPatternType();
            }
            if ($object->isInitialized('supportedDisplayPatternTypes') && null !== $object->getSupportedDisplayPatternTypes()) {
                $values = [];
                foreach ($object->getSupportedDisplayPatternTypes() as $value) {
                    $values[] = $value;
                }
                $data['supportedDisplayPatternTypes'] = $values;
            }
