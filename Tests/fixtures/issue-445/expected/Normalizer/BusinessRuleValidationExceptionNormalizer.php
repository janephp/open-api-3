...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleValidationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\BusinessRuleValidationException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\BusinessRuleValidationException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\BusinessRuleValidationException();
            ...
            if (\array_key_exists('ruleId', $data) && $data['ruleId'] !== null) {
                $object->setRuleId($data['ruleId']);
                unset($data['ruleId']);
            }
            elseif (\array_key_exists('ruleId', $data) && $data['ruleId'] === null) {
            ...
            if (\array_key_exists('innerExceptions', $data) && $data['innerExceptions'] !== null) {
                ...
                foreach ($data['innerExceptions'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \PicturePark\API\Model\PictureparkValidationException::class, 'json', $context);
                }
        ...
        {
            return [\PicturePark\API\Model\BusinessRuleValidationException::class => false];
        }
    }
} else {
    class BusinessRuleValidationExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
