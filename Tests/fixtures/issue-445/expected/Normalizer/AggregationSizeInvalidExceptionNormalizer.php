...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AggregationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\AggregationSizeInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\AggregationSizeInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\AggregationSizeInvalidException();
            ...
            if (\array_key_exists('aggregationSize', $data)) {
                $object->setAggregationSize($data['aggregationSize']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('aggregationSize') && null !== $object->getAggregationSize()) {
                $data['aggregationSize'] = $object->getAggregationSize();
            }
        ...
        {
            return [\PicturePark\API\Model\AggregationSizeInvalidException::class => false];
        }
    }
} else {
    class AggregationSizeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
