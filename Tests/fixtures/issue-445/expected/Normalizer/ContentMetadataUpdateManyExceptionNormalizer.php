...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ContentMetadataUpdateManyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ContentMetadataUpdateManyException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\ContentMetadataUpdateManyException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ContentMetadataUpdateManyException();
            ...
            if (\array_key_exists('failedItemsCount', $data)) {
                $object->setFailedItemsCount($data['failedItemsCount']);
                unset($data['failedItemsCount']);
            }
            if (\array_key_exists('totalItemsCount', $data)) {
                $object->setTotalItemsCount($data['totalItemsCount']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('failedItemsCount') && null !== $object->getFailedItemsCount()) {
                $data['failedItemsCount'] = $object->getFailedItemsCount();
            }
            if ($object->isInitialized('totalItemsCount') && null !== $object->getTotalItemsCount()) {
                $data['totalItemsCount'] = $object->getTotalItemsCount();
            }
        ...
        {
            return [\PicturePark\API\Model\ContentMetadataUpdateManyException::class => false];
        }
    }
} else {
    class ContentMetadataUpdateManyExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
