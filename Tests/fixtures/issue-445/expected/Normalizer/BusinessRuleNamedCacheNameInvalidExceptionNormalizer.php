...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessRuleNamedCacheNameInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\BusinessRuleNamedCacheNameInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\BusinessRuleNamedCacheNameInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\BusinessRuleNamedCacheNameInvalidException();
            ...
            if (\array_key_exists('cacheName', $data) && $data['cacheName'] !== null) {
                $object->setCacheName($data['cacheName']);
                unset($data['cacheName']);
            }
            elseif (\array_key_exists('cacheName', $data) && $data['cacheName'] === null) {
                $object->setCacheName(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('cacheName') && null !== $object->getCacheName()) {
                $data['cacheName'] = $object->getCacheName();
            }
        ...
        {
            return [\PicturePark\API\Model\BusinessRuleNamedCacheNameInvalidException::class => false];
        }
    }
} else {
    class BusinessRuleNamedCacheNameInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
