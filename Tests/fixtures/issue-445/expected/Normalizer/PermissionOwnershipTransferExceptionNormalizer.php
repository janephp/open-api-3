...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class PermissionOwnershipTransferExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\PermissionOwnershipTransferException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\PermissionOwnershipTransferException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\PermissionOwnershipTransferException();
            ...
            if (\array_key_exists('missingUserRight', $data)) {
                $object->setMissingUserRight($data['missingUserRight']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('missingUserRight') && null !== $object->getMissingUserRight()) {
                $data['missingUserRight'] = $object->getMissingUserRight();
            }
        ...
        {
            return [\PicturePark\API\Model\PermissionOwnershipTransferException::class => false];
        }
    }
} else {
    class PermissionOwnershipTransferExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
