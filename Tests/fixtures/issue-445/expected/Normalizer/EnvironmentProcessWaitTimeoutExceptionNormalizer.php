...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class EnvironmentProcessWaitTimeoutExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\EnvironmentProcessWaitTimeoutException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\EnvironmentProcessWaitTimeoutException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\EnvironmentProcessWaitTimeoutException();
            ...
            if (\array_key_exists('environmentProcessId', $data) && $data['environmentProcessId'] !== null) {
                $object->setEnvironmentProcessId($data['environmentProcessId']);
                unset($data['environmentProcessId']);
            }
            elseif (\array_key_exists('environmentProcessId', $data) && $data['environmentProcessId'] === null) {
                $object->setEnvironmentProcessId(null);
            }
            if (\array_key_exists('waitedLifecycles', $data) && $data['waitedLifecycles'] !== null) {
                $object->setWaitedLifecycles($data['waitedLifecycles']);
                unset($data['waitedLifecycles']);
            }
            elseif (\array_key_exists('waitedLifecycles', $data) && $data['waitedLifecycles'] === null) {
                $object->setWaitedLifecycles(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('environmentProcessId') && null !== $object->getEnvironmentProcessId()) {
                $data['environmentProcessId'] = $object->getEnvironmentProcessId();
            }
            if ($object->isInitialized('waitedLifecycles') && null !== $object->getWaitedLifecycles()) {
                $data['waitedLifecycles'] = $object->getWaitedLifecycles();
            }
        ...
        {
            return [\PicturePark\API\Model\EnvironmentProcessWaitTimeoutException::class => false];
        }
    }
} else {
    class EnvironmentProcessWaitTimeoutExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
