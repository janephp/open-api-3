...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class XmpMappingConfigurationInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\XmpMappingConfigurationInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\XmpMappingConfigurationInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\XmpMappingConfigurationInvalidException();
            ...
            if (\array_key_exists('expectedConfiguration', $data) && $data['expectedConfiguration'] !== null) {
                $object->setExpectedConfiguration($data['expectedConfiguration']);
                unset($data['expectedConfiguration']);
            }
            elseif (\array_key_exists('expectedConfiguration', $data) && $data['expectedConfiguration'] === null) {
                $object->setExpectedConfiguration(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('expectedConfiguration') && null !== $object->getExpectedConfiguration()) {
                $data['expectedConfiguration'] = $object->getExpectedConfiguration();
            }
        ...
        {
            return [\PicturePark\API\Model\XmpMappingConfigurationInvalidException::class => false];
        }
    }
} else {
    class XmpMappingConfigurationInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
