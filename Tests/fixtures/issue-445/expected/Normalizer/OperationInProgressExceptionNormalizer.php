...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class OperationInProgressExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\OperationInProgressException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\OperationInProgressException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\OperationInProgressException();
            ...
            if (\array_key_exists('leaseResourceType', $data)) {
                $object->setLeaseResourceType($data['leaseResourceType']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('leaseResourceType') && null !== $object->getLeaseResourceType()) {
                $data['leaseResourceType'] = $object->getLeaseResourceType();
            }
        ...
        {
            return [\PicturePark\API\Model\OperationInProgressException::class => false];
        }
    }
} else {
    class OperationInProgressExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
