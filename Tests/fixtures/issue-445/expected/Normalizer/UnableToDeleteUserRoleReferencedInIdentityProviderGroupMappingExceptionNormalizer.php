...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException();
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('identityProviderIds') && null !== $object->getIdentityProviderIds()) {
                $values = [];
                foreach ($object->getIdentityProviderIds() as $value) {
                    $values[] = $value;
                }
                $data['identityProviderIds'] = $values;
            }
        ...
        {
            return [\PicturePark\API\Model\UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingException::class => false];
        }
    }
} else {
    class UnableToDeleteUserRoleReferencedInIdentityProviderGroupMappingExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
