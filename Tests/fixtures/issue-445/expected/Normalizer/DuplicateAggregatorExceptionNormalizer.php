...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DuplicateAggregatorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DuplicateAggregatorException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\DuplicateAggregatorException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\DuplicateAggregatorException();
            ...
            if (\array_key_exists('aggregatorName', $data) && $data['aggregatorName'] !== null) {
                $object->setAggregatorName($data['aggregatorName']);
                unset($data['aggregatorName']);
            }
            elseif (\array_key_exists('aggregatorName', $data) && $data['aggregatorName'] === null) {
                $object->setAggregatorName(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('aggregatorName') && null !== $object->getAggregatorName()) {
                $data['aggregatorName'] = $object->getAggregatorName();
            }
        ...
        {
            return [\PicturePark\API\Model\DuplicateAggregatorException::class => false];
        }
    }
} else {
    class DuplicateAggregatorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
