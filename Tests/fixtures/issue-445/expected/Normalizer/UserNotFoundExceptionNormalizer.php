...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UserNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\UserNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\UserNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\UserNotFoundException();
            ...
            if (\array_key_exists('missingUserId', $data) && $data['missingUserId'] !== null) {
                $object->setMissingUserId($data['missingUserId']);
                unset($data['missingUserId']);
            }
            elseif (\array_key_exists('missingUserId', $data) && $data['missingUserId'] === null) {
                $object->setMissingUserId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('missingUserId') && null !== $object->getMissingUserId()) {
                $data['missingUserId'] = $object->getMissingUserId();
            }
        ...
        {
            return [\PicturePark\API\Model\UserNotFoundException::class => false];
        }
    }
} else {
    class UserNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
