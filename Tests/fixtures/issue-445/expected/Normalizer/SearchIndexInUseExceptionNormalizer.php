...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SearchIndexInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SearchIndexInUseException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SearchIndexInUseException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SearchIndexInUseException();
            ...
            if (\array_key_exists('searchIndex', $data) && $data['searchIndex'] !== null) {
                $object->setSearchIndex($data['searchIndex']);
                unset($data['searchIndex']);
            }
            elseif (\array_key_exists('searchIndex', $data) && $data['searchIndex'] === null) {
                $object->setSearchIndex(null);
            }
        ...
        {
            return [\PicturePark\API\Model\SearchIndexInUseException::class => false];
        }
    }
} else {
    class SearchIndexInUseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
