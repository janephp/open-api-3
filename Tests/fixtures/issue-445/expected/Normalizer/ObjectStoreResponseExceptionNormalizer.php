...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ObjectStoreResponseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ObjectStoreResponseException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ObjectStoreResponseException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ObjectStoreResponseException();
            ...
            if (\array_key_exists('rowErrorMessages', $data) && $data['rowErrorMessages'] !== null) {
                $object->setRowErrorMessages($data['rowErrorMessages']);
                unset($data['rowErrorMessages']);
            }
            elseif (\array_key_exists('rowErrorMessages', $data) && $data['rowErrorMessages'] === null) {
                $object->setRowErrorMessages(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('rowErrorMessages') && null !== $object->getRowErrorMessages()) {
                $data['rowErrorMessages'] = $object->getRowErrorMessages();
            }
        ...
        {
            return [\PicturePark\API\Model\ObjectStoreResponseException::class => false];
        }
    }
} else {
    class ObjectStoreResponseExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
