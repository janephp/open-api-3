...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ServiceProviderDeleteExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ServiceProviderDeleteException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ServiceProviderDeleteException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\ServiceProviderDeleteException();
            ...
            if (\array_key_exists('serviceProviderId', $data) && $data['serviceProviderId'] !== null) {
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('serviceProviderId') && null !== $object->getServiceProviderId()) {
                $data['serviceProviderId'] = $object->getServiceProviderId();
            }
            if ($object->isInitialized('detailedErrorMessage') && null !== $object->getDetailedErrorMessage()) {
                $data['detailedErrorMessage'] = $object->getDetailedErrorMessage();
            }
        ...
        {
            return [\PicturePark\API\Model\ServiceProviderDeleteException::class => false];
        }
    }
} else {
    class ServiceProviderDeleteExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
