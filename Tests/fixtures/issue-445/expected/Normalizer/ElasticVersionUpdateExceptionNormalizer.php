...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ElasticVersionUpdateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ElasticVersionUpdateException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ElasticVersionUpdateException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ElasticVersionUpdateException();
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('expectedVersion') && null !== $object->getExpectedVersion()) {
                $data['expectedVersion'] = $object->getExpectedVersion();
            }
            if ($object->isInitialized('actualVersion') && null !== $object->getActualVersion()) {
        ...
        {
            return [\PicturePark\API\Model\ElasticVersionUpdateException::class => false];
        }
    }
} else {
    class ElasticVersionUpdateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
