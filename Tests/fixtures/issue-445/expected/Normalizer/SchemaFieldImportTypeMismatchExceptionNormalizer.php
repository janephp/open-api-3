...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldImportTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldImportTypeMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldImportTypeMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldImportTypeMismatchException();
            ...
            if (\array_key_exists('importingFieldType', $data) && $data['importingFieldType'] !== null) {
                $object->setImportingFieldType($data['importingFieldType']);
                unset($data['importingFieldType']);
            }
            elseif (\array_key_exists('importingFieldType', $data) && $data['importingFieldType'] === null) {
                $object->setImportingFieldType(null);
            }
            if (\array_key_exists('existingFieldType', $data) && $data['existingFieldType'] !== null) {
                $object->setExistingFieldType($data['existingFieldType']);
                unset($data['existingFieldType']);
            }
            elseif (\array_key_exists('existingFieldType', $data) && $data['existingFieldType'] === null) {
                $object->setExistingFieldType(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('importingFieldType') && null !== $object->getImportingFieldType()) {
                $data['importingFieldType'] = $object->getImportingFieldType();
            }
            if ($object->isInitialized('existingFieldType') && null !== $object->getExistingFieldType()) {
                $data['existingFieldType'] = $object->getExistingFieldType();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldImportTypeMismatchException::class => false];
        }
    }
} else {
    class SchemaFieldImportTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
