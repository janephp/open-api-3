...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DuplicatedSearchBehaviorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DuplicatedSearchBehaviorException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\DuplicatedSearchBehaviorException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\DuplicatedSearchBehaviorException();
            ...
            if (\array_key_exists('duplicatedSearchBehaviors', $data) && $data['duplicatedSearchBehaviors'] !== null) {
                $object->setDuplicatedSearchBehaviors($data['duplicatedSearchBehaviors']);
                unset($data['duplicatedSearchBehaviors']);
            }
            elseif (\array_key_exists('duplicatedSearchBehaviors', $data) && $data['duplicatedSearchBehaviors'] === null) {
                $object->setDuplicatedSearchBehaviors(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('duplicatedSearchBehaviors') && null !== $object->getDuplicatedSearchBehaviors()) {
                $data['duplicatedSearchBehaviors'] = $object->getDuplicatedSearchBehaviors();
            }
        ...
        {
            return [\PicturePark\API\Model\DuplicatedSearchBehaviorException::class => false];
        }
    }
} else {
    class DuplicatedSearchBehaviorExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
