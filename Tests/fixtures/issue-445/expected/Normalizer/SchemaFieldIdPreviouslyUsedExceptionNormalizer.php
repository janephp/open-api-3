...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldIdPreviouslyUsedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldIdPreviouslyUsedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldIdPreviouslyUsedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldIdPreviouslyUsedException();
            ...
            if (\array_key_exists('usedInSchemaId', $data) && $data['usedInSchemaId'] !== null) {
                $object->setUsedInSchemaId($data['usedInSchemaId']);
                unset($data['usedInSchemaId']);
            }
            elseif (\array_key_exists('usedInSchemaId', $data) && $data['usedInSchemaId'] === null) {
                $object->setUsedInSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('usedInSchemaId') && null !== $object->getUsedInSchemaId()) {
                $data['usedInSchemaId'] = $object->getUsedInSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldIdPreviouslyUsedException::class => false];
        }
    }
} else {
    class SchemaFieldIdPreviouslyUsedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
