...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ListItemSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ListItemSchemaMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ListItemSchemaMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ListItemSchemaMismatchException();
            ...
            if (\array_key_exists('listItemId', $data) && $data['listItemId'] !== null) {
                $object->setListItemId($data['listItemId']);
                unset($data['listItemId']);
            }
            elseif (\array_key_exists('listItemId', $data) && $data['listItemId'] === null) {
                $object->setListItemId(null);
            }
            if (\array_key_exists('listItemSchemaId', $data) && $data['listItemSchemaId'] !== null) {
                $object->setListItemSchemaId($data['listItemSchemaId']);
                unset($data['listItemSchemaId']);
            }
            elseif (\array_key_exists('listItemSchemaId', $data) && $data['listItemSchemaId'] === null) {
                $object->setListItemSchemaId(null);
            }
            if (\array_key_exists('fieldSchemaId', $data) && $data['fieldSchemaId'] !== null) {
                $object->setFieldSchemaId($data['fieldSchemaId']);
                unset($data['fieldSchemaId']);
            }
            elseif (\array_key_exists('fieldSchemaId', $data) && $data['fieldSchemaId'] === null) {
                $object->setFieldSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('listItemId') && null !== $object->getListItemId()) {
                $data['listItemId'] = $object->getListItemId();
            }
            if ($object->isInitialized('listItemSchemaId') && null !== $object->getListItemSchemaId()) {
                $data['listItemSchemaId'] = $object->getListItemSchemaId();
            }
            if ($object->isInitialized('fieldSchemaId') && null !== $object->getFieldSchemaId()) {
                $data['fieldSchemaId'] = $object->getFieldSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\ListItemSchemaMismatchException::class => false];
        }
    }
} else {
    class ListItemSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
