...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldImportMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldImportMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldImportMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldImportMismatchException();
            ...
            if (\array_key_exists('importingFieldIds', $data) && $data['importingFieldIds'] !== null) {
                $object->setImportingFieldIds($data['importingFieldIds']);
                unset($data['importingFieldIds']);
            }
            elseif (\array_key_exists('importingFieldIds', $data) && $data['importingFieldIds'] === null) {
                $object->setImportingFieldIds(null);
            }
            if (\array_key_exists('existingFieldIds', $data) && $data['existingFieldIds'] !== null) {
                $object->setExistingFieldIds($data['existingFieldIds']);
                unset($data['existingFieldIds']);
            }
            elseif (\array_key_exists('existingFieldIds', $data) && $data['existingFieldIds'] === null) {
                $object->setExistingFieldIds(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('importingFieldIds') && null !== $object->getImportingFieldIds()) {
                $data['importingFieldIds'] = $object->getImportingFieldIds();
            }
            if ($object->isInitialized('existingFieldIds') && null !== $object->getExistingFieldIds()) {
                $data['existingFieldIds'] = $object->getExistingFieldIds();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldImportMismatchException::class => false];
        }
    }
} else {
    class SchemaFieldImportMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
