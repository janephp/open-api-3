...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ConfigurationIndexNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ConfigurationIndexNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\ConfigurationIndexNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\ConfigurationIndexNotFoundException();
            ...
            if (\array_key_exists('configurationIndex', $data) && $data['configurationIndex'] !== null) {
                $object->setConfigurationIndex($data['configurationIndex']);
                unset($data['configurationIndex']);
            }
            elseif (\array_key_exists('configurationIndex', $data) && $data['configurationIndex'] === null) {
                $object->setConfigurationIndex(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('configurationIndex') && null !== $object->getConfigurationIndex()) {
                $data['configurationIndex'] = $object->getConfigurationIndex();
            }
        ...
        {
            return [\PicturePark\API\Model\ConfigurationIndexNotFoundException::class => false];
        }
    }
} else {
    class ConfigurationIndexNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
