...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldImportRelatedSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldImportRelatedSchemaMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\SchemaFieldImportRelatedSchemaMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldImportRelatedSchemaMismatchException();
            ...
            if (\array_key_exists('importingRelatedSchemaId', $data) && $data['importingRelatedSchemaId'] !== null) {
                $object->setImportingRelatedSchemaId($data['importingRelatedSchemaId']);
                unset($data['importingRelatedSchemaId']);
            }
            elseif (\array_key_exists('importingRelatedSchemaId', $data) && $data['importingRelatedSchemaId'] === null) {
                $object->setImportingRelatedSchemaId(null);
            }
            if (\array_key_exists('existingRelatedSchemaId', $data) && $data['existingRelatedSchemaId'] !== null) {
                $object->setExistingRelatedSchemaId($data['existingRelatedSchemaId']);
                unset($data['existingRelatedSchemaId']);
            }
            elseif (\array_key_exists('existingRelatedSchemaId', $data) && $data['existingRelatedSchemaId'] === null) {
                $object->setExistingRelatedSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('importingRelatedSchemaId') && null !== $object->getImportingRelatedSchemaId()) {
                $data['importingRelatedSchemaId'] = $object->getImportingRelatedSchemaId();
            }
            if ($object->isInitialized('existingRelatedSchemaId') && null !== $object->getExistingRelatedSchemaId()) {
                $data['existingRelatedSchemaId'] = $object->getExistingRelatedSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldImportRelatedSchemaMismatchException::class => false];
        }
    }
} else {
    class SchemaFieldImportRelatedSchemaMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
