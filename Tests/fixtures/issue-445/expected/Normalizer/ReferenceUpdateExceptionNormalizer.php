...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReferenceUpdateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\ReferenceUpdateException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\ReferenceUpdateException::class;
        }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('referenceItemId') && null !== $object->getReferenceItemId()) {
                $data['referenceItemId'] = $object->getReferenceItemId();
            }
            if ($object->isInitialized('referenceType') && null !== $object->getReferenceType()) {
        ...
        {
            return [\PicturePark\API\Model\ReferenceUpdateException::class => false];
        }
    }
} else {
    class ReferenceUpdateExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
