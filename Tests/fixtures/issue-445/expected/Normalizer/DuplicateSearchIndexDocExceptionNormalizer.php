...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DuplicateSearchIndexDocExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DuplicateSearchIndexDocException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\DuplicateSearchIndexDocException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\DuplicateSearchIndexDocException();
            ...
            if (\array_key_exists('searchIndexDocId', $data) && $data['searchIndexDocId'] !== null) {
                $object->setSearchIndexDocId($data['searchIndexDocId']);
                unset($data['searchIndexDocId']);
            }
            elseif (\array_key_exists('searchIndexDocId', $data) && $data['searchIndexDocId'] === null) {
                $object->setSearchIndexDocId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('searchIndexDocId') && null !== $object->getSearchIndexDocId()) {
                $data['searchIndexDocId'] = $object->getSearchIndexDocId();
            }
        ...
        {
            return [\PicturePark\API\Model\DuplicateSearchIndexDocException::class => false];
        }
    }
} else {
    class DuplicateSearchIndexDocExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
