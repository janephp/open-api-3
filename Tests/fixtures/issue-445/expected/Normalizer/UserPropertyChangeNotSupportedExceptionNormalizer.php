...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UserPropertyChangeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\UserPropertyChangeNotSupportedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\UserPropertyChangeNotSupportedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\UserPropertyChangeNotSupportedException();
            ...
            if (\array_key_exists('propertyPath', $data) && $data['propertyPath'] !== null) {
                $object->setPropertyPath($data['propertyPath']);
                unset($data['propertyPath']);
            }
            elseif (\array_key_exists('propertyPath', $data) && $data['propertyPath'] === null) {
                $object->setPropertyPath(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('propertyPath') && null !== $object->getPropertyPath()) {
                $data['propertyPath'] = $object->getPropertyPath();
            }
            if ($object->isInitialized('affectedUserId') && null !== $object->getAffectedUserId()) {
                $data['affectedUserId'] = $object->getAffectedUserId();
            }
        ...
        {
            return [\PicturePark\API\Model\UserPropertyChangeNotSupportedException::class => false];
        }
    }
} else {
    class UserPropertyChangeNotSupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
