...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldOverwriteTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldOverwriteTypeMismatchException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldOverwriteTypeMismatchException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldOverwriteTypeMismatchException();
            ...
            if (\array_key_exists('fieldOverwriteType', $data) && $data['fieldOverwriteType'] !== null) {
                $object->setFieldOverwriteType($data['fieldOverwriteType']);
                unset($data['fieldOverwriteType']);
            }
            elseif (\array_key_exists('fieldOverwriteType', $data) && $data['fieldOverwriteType'] === null) {
                $object->setFieldOverwriteType(null);
            }
            if (\array_key_exists('fieldType', $data) && $data['fieldType'] !== null) {
                $object->setFieldType($data['fieldType']);
                unset($data['fieldType']);
            }
            elseif (\array_key_exists('fieldType', $data) && $data['fieldType'] === null) {
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('fieldOverwriteType') && null !== $object->getFieldOverwriteType()) {
                $data['fieldOverwriteType'] = $object->getFieldOverwriteType();
            }
            if ($object->isInitialized('fieldType') && null !== $object->getFieldType()) {
                $data['fieldType'] = $object->getFieldType();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldOverwriteTypeMismatchException::class => false];
        }
    }
} else {
    class SchemaFieldOverwriteTypeMismatchExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
