...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class IdentityProviderNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\IdentityProviderNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\IdentityProviderNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('missingIdentityProviderId', $data) && $data['missingIdentityProviderId'] !== null) {
                $object->setMissingIdentityProviderId($data['missingIdentityProviderId']);
                unset($data['missingIdentityProviderId']);
            }
            elseif (\array_key_exists('missingIdentityProviderId', $data) && $data['missingIdentityProviderId'] === null) {
                $object->setMissingIdentityProviderId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('missingIdentityProviderId') && null !== $object->getMissingIdentityProviderId()) {
                $data['missingIdentityProviderId'] = $object->getMissingIdentityProviderId();
            }
        ...
        {
            return [\PicturePark\API\Model\IdentityProviderNotFoundException::class => false];
        }
    }
} else {
    class IdentityProviderNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
