...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BusinessProcessEngineRequestExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\BusinessProcessEngineRequestException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\BusinessProcessEngineRequestException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\BusinessProcessEngineRequestException();
            ...
            if (\array_key_exists('engineError', $data) && $data['engineError'] !== null) {
                $object->setEngineError($data['engineError']);
                unset($data['engineError']);
            }
            elseif (\array_key_exists('engineError', $data) && $data['engineError'] === null) {
                $object->setEngineError(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('engineError') && null !== $object->getEngineError()) {
                $data['engineError'] = $object->getEngineError();
            }
        ...
        {
            return [\PicturePark\API\Model\BusinessProcessEngineRequestException::class => false];
        }
    }
} else {
    class BusinessProcessEngineRequestExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
