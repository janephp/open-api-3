...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class DeleteContentsWithReferencesExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\DeleteContentsWithReferencesException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\DeleteContentsWithReferencesException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\DeleteContentsWithReferencesException();
            ...
            if (\array_key_exists('numberOfReferences', $data)) {
                $object->setNumberOfReferences($data['numberOfReferences']);
                unset($data['numberOfReferences']);
            }
            if (\array_key_exists('numberOfShares', $data)) {
                $object->setNumberOfShares($data['numberOfShares']);
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('numberOfReferences') && null !== $object->getNumberOfReferences()) {
                $data['numberOfReferences'] = $object->getNumberOfReferences();
            }
            if ($object->isInitialized('numberOfShares') && null !== $object->getNumberOfShares()) {
                $data['numberOfShares'] = $object->getNumberOfShares();
            }
        ...
        {
            return [\PicturePark\API\Model\DeleteContentsWithReferencesException::class => false];
        }
    }
} else {
    class DeleteContentsWithReferencesExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
