...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FileTransferNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\FileTransferNotFoundException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\FileTransferNotFoundException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\FileTransferNotFoundException();
            ...
            if (\array_key_exists('fileTransferId', $data) && $data['fileTransferId'] !== null) {
                $object->setFileTransferId($data['fileTransferId']);
                unset($data['fileTransferId']);
            }
            elseif (\array_key_exists('fileTransferId', $data) && $data['fileTransferId'] === null) {
                $object->setFileTransferId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('fileTransferId') && null !== $object->getFileTransferId()) {
        ...
        {
            return [\PicturePark\API\Model\FileTransferNotFoundException::class => false];
        }
    }
} else {
    class FileTransferNotFoundExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
