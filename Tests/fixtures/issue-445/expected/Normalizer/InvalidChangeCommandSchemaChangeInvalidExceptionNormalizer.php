...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InvalidChangeCommandSchemaChangeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\InvalidChangeCommandSchemaChangeInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\InvalidChangeCommandSchemaChangeInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\InvalidChangeCommandSchemaChangeInvalidException();
            ...
            if (\array_key_exists('commandTypeName', $data) && $data['commandTypeName'] !== null) {
                $object->setCommandTypeName($data['commandTypeName']);
                unset($data['commandTypeName']);
            }
            elseif (\array_key_exists('commandTypeName', $data) && $data['commandTypeName'] === null) {
                $object->setCommandTypeName(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('commandTypeName') && null !== $object->getCommandTypeName()) {
                $data['commandTypeName'] = $object->getCommandTypeName();
            }
        ...
        {
            return [\PicturePark\API\Model\InvalidChangeCommandSchemaChangeInvalidException::class => false];
        }
    }
} else {
    class InvalidChangeCommandSchemaChangeInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
