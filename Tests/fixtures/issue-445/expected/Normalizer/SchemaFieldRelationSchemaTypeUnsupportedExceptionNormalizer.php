...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SchemaFieldRelationSchemaTypeUnsupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\SchemaFieldRelationSchemaTypeUnsupportedException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \PicturePark\API\Model\SchemaFieldRelationSchemaTypeUnsupportedException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\SchemaFieldRelationSchemaTypeUnsupportedException();
            ...
            if (\array_key_exists('relationSchemaId', $data) && $data['relationSchemaId'] !== null) {
                $object->setRelationSchemaId($data['relationSchemaId']);
                unset($data['relationSchemaId']);
            }
            elseif (\array_key_exists('relationSchemaId', $data) && $data['relationSchemaId'] === null) {
                $object->setRelationSchemaId(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('relationSchemaId') && null !== $object->getRelationSchemaId()) {
                $data['relationSchemaId'] = $object->getRelationSchemaId();
            }
        ...
        {
            return [\PicturePark\API\Model\SchemaFieldRelationSchemaTypeUnsupportedException::class => false];
        }
    }
} else {
    class SchemaFieldRelationSchemaTypeUnsupportedExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
