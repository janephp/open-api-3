...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class InvalidDateTimeFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\InvalidDateTimeFormatException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\InvalidDateTimeFormatException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \PicturePark\API\Model\InvalidDateTimeFormatException();
            ...
            if (\array_key_exists('expectedFormat', $data) && $data['expectedFormat'] !== null) {
                $object->setExpectedFormat($data['expectedFormat']);
                unset($data['expectedFormat']);
            }
            elseif (\array_key_exists('expectedFormat', $data) && $data['expectedFormat'] === null) {
        ...
        public function normalize(mixed $object, string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('expectedFormat') && null !== $object->getExpectedFormat()) {
                $data['expectedFormat'] = $object->getExpectedFormat();
            }
        ...
        {
            return [\PicturePark\API\Model\InvalidDateTimeFormatException::class => false];
        }
    }
} else {
    class InvalidDateTimeFormatExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
