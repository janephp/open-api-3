...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class AggregationNameInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \PicturePark\API\Model\AggregationNameInvalidException::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === PicturePark\API\Model\AggregationNameInvalidException::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            $object = new \PicturePark\API\Model\AggregationNameInvalidException();
            ...
            if (\array_key_exists('aggregationPrefix', $data) && $data['aggregationPrefix'] !== null) {
                $object->setAggregationPrefix($data['aggregationPrefix']);
                unset($data['aggregationPrefix']);
            }
            elseif (\array_key_exists('aggregationPrefix', $data) && $data['aggregationPrefix'] === null) {
                $object->setAggregationPrefix(null);
            }
        ...
        public function normalize(mixed $object, string $format = null, array $context = []) : array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('aggregationPrefix') && null !== $object->getAggregationPrefix()) {
                $data['aggregationPrefix'] = $object->getAggregationPrefix();
            }
        ...
        {
            return [\PicturePark\API\Model\AggregationNameInvalidException::class => false];
        }
    }
} else {
    class AggregationNameInvalidExceptionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
