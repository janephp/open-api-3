...
class OutputFormatUpdate extends \PicturePark\API\Runtime\Client\BaseEndpoint implements \PicturePark\API\Runtime\Client\Endpoint
{
    protected $id;
    /**
    ...
    {
        if ($this->body instanceof \PicturePark\API\Model\OutputFormatEditable) {
