...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class FullTextEntitiesAnnotationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Jane\Component\OpenApi3\Tests\Expected\Model\FullTextEntitiesAnnotationsItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === Jane\Component\OpenApi3\Tests\Expected\Model\FullTextEntitiesAnnotationsItem::class;
        }
        ...
        {
            return [\Jane\Component\OpenApi3\Tests\Expected\Model\FullTextEntitiesAnnotationsItem::class => false];
        }
    }
} else {
    class FullTextEntitiesAnnotationsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
