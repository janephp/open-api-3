...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposOwnerRepoCheckRunsPostBodyOutputImagesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposOwnerRepoCheckRunsPostBodyOutputImagesItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ReposOwnerRepoCheckRunsPostBodyOutputImagesItem::class;
        }
        ...
        {
            return [\Github\Model\ReposOwnerRepoCheckRunsPostBodyOutputImagesItem::class => false];
        }
    }
} else {
    class ReposOwnerRepoCheckRunsPostBodyOutputImagesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
