...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposOwnerRepoActionsSecretsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposOwnerRepoActionsSecretsGetResponse200::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ReposOwnerRepoActionsSecretsGetResponse200::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (!($context['skip_validation'] ?? false)) {
                $this->validate($data, new \Github\Validator\ReposOwnerRepoActionsSecretsGetResponse200Constraint());
            }
            ...
            if (\array_key_exists('secrets', $data)) {
                ...
                foreach ($data['secrets'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Github\Model\ActionsSecret::class, 'json', $context);
                }
        ...
        {
            return [\Github\Model\ReposOwnerRepoActionsSecretsGetResponse200::class => false];
        }
    }
} else {
    class ReposOwnerRepoActionsSecretsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
