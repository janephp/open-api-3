...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TeamsTeamIdDiscussionsDiscussionNumberPatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\TeamsTeamIdDiscussionsDiscussionNumberPatchBody::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Github\Model\TeamsTeamIdDiscussionsDiscussionNumberPatchBody::class;
        }
        ...
        {
            return [\Github\Model\TeamsTeamIdDiscussionsDiscussionNumberPatchBody::class => false];
        }
    }
} else {
    class TeamsTeamIdDiscussionsDiscussionNumberPatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
