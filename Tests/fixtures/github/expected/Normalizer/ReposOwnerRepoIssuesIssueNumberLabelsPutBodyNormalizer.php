...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposOwnerRepoIssuesIssueNumberLabelsPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposOwnerRepoIssuesIssueNumberLabelsPutBody::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ReposOwnerRepoIssuesIssueNumberLabelsPutBody::class;
        }
        ...
        {
            return [\Github\Model\ReposOwnerRepoIssuesIssueNumberLabelsPutBody::class => false];
        }
    }
} else {
    class ReposOwnerRepoIssuesIssueNumberLabelsPutBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
