...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposTemplateOwnerTemplateRepoGeneratePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposTemplateOwnerTemplateRepoGeneratePostBody::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ReposTemplateOwnerTemplateRepoGeneratePostBody::class;
        }
        ...
        {
            return [\Github\Model\ReposTemplateOwnerTemplateRepoGeneratePostBody::class => false];
        }
    }
} else {
    class ReposTemplateOwnerTemplateRepoGeneratePostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
