...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposOwnerRepoPullsPullNumberUpdateBranchPutResponse202Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposOwnerRepoPullsPullNumberUpdateBranchPutResponse202::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Github\Model\ReposOwnerRepoPullsPullNumberUpdateBranchPutResponse202::class;
        }
        ...
        {
            return [\Github\Model\ReposOwnerRepoPullsPullNumberUpdateBranchPutResponse202::class => false];
        }
    }
} else {
    class ReposOwnerRepoPullsPullNumberUpdateBranchPutResponse202Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
