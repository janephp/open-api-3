...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReposOwnerRepoCheckSuitesPreferencesPatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ReposOwnerRepoCheckSuitesPreferencesPatchBody::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === Github\Model\ReposOwnerRepoCheckSuitesPreferencesPatchBody::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []) : mixed
        {
            ...
            if (\array_key_exists('auto_trigger_checks', $data)) {
                ...
                foreach ($data['auto_trigger_checks'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Github\Model\ReposOwnerRepoCheckSuitesPreferencesPatchBodyAutoTriggerChecksItem::class, 'json', $context);
                }
        ...
        {
            return [\Github\Model\ReposOwnerRepoCheckSuitesPreferencesPatchBody::class => false];
        }
    }
} else {
    class ReposOwnerRepoCheckSuitesPreferencesPatchBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
