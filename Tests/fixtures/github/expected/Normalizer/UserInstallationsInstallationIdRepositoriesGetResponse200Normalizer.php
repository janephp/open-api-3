...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class UserInstallationsInstallationIdRepositoriesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\UserInstallationsInstallationIdRepositoriesGetResponse200::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Github\Model\UserInstallationsInstallationIdRepositoriesGetResponse200::class;
        }
        ...
        {
            return [\Github\Model\UserInstallationsInstallationIdRepositoriesGetResponse200::class => false];
        }
    }
} else {
    class UserInstallationsInstallationIdRepositoriesGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
