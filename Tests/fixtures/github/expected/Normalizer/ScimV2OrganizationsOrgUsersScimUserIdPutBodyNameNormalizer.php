...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ScimV2OrganizationsOrgUsersScimUserIdPutBodyNameNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ScimV2OrganizationsOrgUsersScimUserIdPutBodyName::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ScimV2OrganizationsOrgUsersScimUserIdPutBodyName::class;
        }
        ...
        {
            return [\Github\Model\ScimV2OrganizationsOrgUsersScimUserIdPutBodyName::class => false];
        }
    }
} else {
    class ScimV2OrganizationsOrgUsersScimUserIdPutBodyNameNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
