...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class TeamsTeamIdMembersUsernamePutResponse422ErrorsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\TeamsTeamIdMembersUsernamePutResponse422ErrorsItem::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Github\Model\TeamsTeamIdMembersUsernamePutResponse422ErrorsItem::class;
        }
        ...
        {
            return [\Github\Model\TeamsTeamIdMembersUsernamePutResponse422ErrorsItem::class => false];
        }
    }
} else {
    class TeamsTeamIdMembersUsernamePutResponse422ErrorsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
