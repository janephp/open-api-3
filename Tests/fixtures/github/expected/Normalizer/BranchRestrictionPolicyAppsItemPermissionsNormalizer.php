...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BranchRestrictionPolicyAppsItemPermissionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\BranchRestrictionPolicyAppsItemPermissions::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Github\Model\BranchRestrictionPolicyAppsItemPermissions::class;
        }
        ...
        {
            return [\Github\Model\BranchRestrictionPolicyAppsItemPermissions::class => false];
        }
    }
} else {
    class BranchRestrictionPolicyAppsItemPermissionsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
