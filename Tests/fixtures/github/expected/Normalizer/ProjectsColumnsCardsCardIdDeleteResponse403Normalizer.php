...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProjectsColumnsCardsCardIdDeleteResponse403Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Github\Model\ProjectsColumnsCardsCardIdDeleteResponse403::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === Github\Model\ProjectsColumnsCardsCardIdDeleteResponse403::class;
        }
        ...
        {
            return [\Github\Model\ProjectsColumnsCardsCardIdDeleteResponse403::class => false];
        }
    }
} else {
    class ProjectsColumnsCardsCardIdDeleteResponse403Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
