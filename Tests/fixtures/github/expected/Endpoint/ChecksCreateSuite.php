...
class ChecksCreateSuite extends \Github\Runtime\Client\BaseEndpoint implements \Github\Runtime\Client\Endpoint
{
    protected $owner;
    protected $repo;
    /**
    ...
    */
    ...
    {
        if ($this->body instanceof \Github\Model\ReposOwnerRepoCheckSuitesPostBody) {
