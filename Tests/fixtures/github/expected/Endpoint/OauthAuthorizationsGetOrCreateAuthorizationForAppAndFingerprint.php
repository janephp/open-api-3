...
class OauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint extends \Github\Runtime\Client\BaseEndpoint implements \Github\Runtime\Client\Endpoint
{
    protected $client_id;
