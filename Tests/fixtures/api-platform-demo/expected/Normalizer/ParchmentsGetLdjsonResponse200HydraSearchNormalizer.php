...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ParchmentsGetLdjsonResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ApiPlatform\Demo\Model\ParchmentsGetLdjsonResponse200HydraSearch::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === ApiPlatform\Demo\Model\ParchmentsGetLdjsonResponse200HydraSearch::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            if (\array_key_exists('hydra:mapping', $data)) {
                ...
                foreach ($data['hydra:mapping'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \ApiPlatform\Demo\Model\ParchmentsGetLdjsonResponse200HydraSearchHydraMappingItem::class, 'json', $context);
                }
        ...
        {
            return [\ApiPlatform\Demo\Model\ParchmentsGetLdjsonResponse200HydraSearch::class => false];
        }
    }
} else {
    class ParchmentsGetLdjsonResponse200HydraSearchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
