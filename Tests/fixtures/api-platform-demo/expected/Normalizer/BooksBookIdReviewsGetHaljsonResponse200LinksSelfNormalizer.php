...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BooksBookIdReviewsGetHaljsonResponse200LinksSelfNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ApiPlatform\Demo\Model\BooksBookIdReviewsGetHaljsonResponse200LinksSelf::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []) : bool
        {
            return is_object($data) && get_class($data) === ApiPlatform\Demo\Model\BooksBookIdReviewsGetHaljsonResponse200LinksSelf::class;
        }
        ...
        {
            return [\ApiPlatform\Demo\Model\BooksBookIdReviewsGetHaljsonResponse200LinksSelf::class => false];
        }
    }
} else {
    class BooksBookIdReviewsGetHaljsonResponse200LinksSelfNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
