...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BooksBookIdReviewsGetLdjsonResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ApiPlatform\Demo\Model\BooksBookIdReviewsGetLdjsonResponse200HydraView::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === ApiPlatform\Demo\Model\BooksBookIdReviewsGetLdjsonResponse200HydraView::class;
        }
        ...
        {
            return [\ApiPlatform\Demo\Model\BooksBookIdReviewsGetLdjsonResponse200HydraView::class => false];
        }
    }
} else {
    class BooksBookIdReviewsGetLdjsonResponse200HydraViewNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
