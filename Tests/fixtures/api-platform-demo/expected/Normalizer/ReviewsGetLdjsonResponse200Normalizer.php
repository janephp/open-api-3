...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ReviewsGetLdjsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200();
            ...
            if (\array_key_exists('hydra:view', $data)) {
                $object->setHydraView($this->denormalizer->denormalize($data['hydra:view'], \ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200HydraView::class, 'json', $context));
                unset($data['hydra:view']);
            }
            if (\array_key_exists('hydra:search', $data)) {
                $object->setHydraSearch($this->denormalizer->denormalize($data['hydra:search'], \ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200HydraSearch::class, 'json', $context));
        ...
        {
            return [\ApiPlatform\Demo\Model\ReviewsGetLdjsonResponse200::class => false];
        }
    }
} else {
    class ReviewsGetLdjsonResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
